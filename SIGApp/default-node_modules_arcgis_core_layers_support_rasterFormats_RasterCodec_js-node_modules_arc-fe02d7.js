"use strict";
(self["webpackChunkrealgis"] = self["webpackChunkrealgis"] || []).push([["default-node_modules_arcgis_core_layers_support_rasterFormats_RasterCodec_js-node_modules_arc-fe02d7"],{
...
a.exports, r = a, n = function () {
  ...
  return function () {
    ...
    var r = new Uint8Array([0, 1, 8, 16, 9, 2, 3, 10, 17, 24, 32, 25, 18, 11, 4, 5, 12, 19, 26, 33, 40, 48, 41, 34, 27, 20, 13, 6, 7, 14, 21, 28, 35, 42, 49, 56, 57, 50, 43, 36, 29, 22, 15, 23, 30, 37, 44, 51, 58, 59, 52, 45, 38, 31, 39, 46, 53, 60, 61, 54, 47, 55, 62, 63]),
      n = 4017,
      o = 799,
      a = 3406,
      t = 2276,
    ...
    function u(e, r) {
      for (var n, o, a = 0, t = [], i = 16; i > 0 && !e[i - 1];) i--;
      t.push({
        children: [],
        index: 0
      });
      ...
      for (n = 0; n < i; n++) {
        for (o = 0; o < e[n]; o++) {
          ...
          for (c.index++, t.push(c); t.length <= n;) t.push(s = {
            children: [],
            index: 0
    ...
    function v(n, o, a, t, i, s, c, f, l) {
      ...
      function k() {
        ...
        if (255 === (d = n[o++])) {
          var r = n[o++];
          if (r) throw new e("unexpected marker " + (d << 8 | r).toString(16));
        }
        return b = 7, d >>> 7;
      }
      function g(r) {
        for (var n = r;;) {
          if ("number" == typeof (n = n[k()])) return n;
          if ("object" != typeof n) throw new e("invalid huffman sequence");
        }
      }
      function C(e) {
        for (var r = 0; e > 0;) r = r << 1 | k(), e--;
        return r;
      }
      function w(e) {
      ...
      function _(n, o) {
        for (var a, t, i = s, f = c, u = 0; i <= f;) {
          ...
          switch (A) {
            case 0:
              if (u = (t = g(n.huffmanTableAC)) >> 4, 0 == (a = 15 & t)) u < 15 ? (T = C(u) + (1 << u), A = 4) : (u = 16, A = 1);else {
            ...
            case 1:
            case 2:
              n.blockData[o + h] ? n.blockData[o + h] += k() << l : 0 == --u && (A = 2 === A ? 3 : 0);
              break;
            case 3:
              n.blockData[o + h] ? n.blockData[o + h] += k() << l : (n.blockData[o + h] = L << l, A = 0);
              break;
            case 4:
              n.blockData[o + h] && (n.blockData[o + h] += k() << l);
          }
          i++;
        }
        4 === A && 0 == --T && (A = 0);
      }
      function U(e, r, n, o, a) {
        var t = n % u;
        r(e, h(e, (n / u | 0) * e.v + o, t * e.h + a));
      }
      function z(e, r, n) {
      ...
      for (E = 1 === R ? t[0].blocksPerLine * t[0].blocksPerColumn : u * a.mcusPerColumn; B < E;) {
        ...
        b = 0, (j = p(n, o)) && j.invalid && (console.log("decodeScan - unexpected MCU data, next marker is: " + j.invalid), o = j.offset);
        var G = j && j.marker;
        if (!G || G <= 65280) throw new e("marker was not found");
        if (!(G >= 65488 && G <= 65495)) break;
        o += 2;
      }
      return (j = p(n, o)) && j.invalid && (console.log("decodeScan - unexpected Scan data, next marker is: " + j.invalid), o = j.offset), o - m;
    }
    function m(r, l, u) {
      var h,
        v,
    ...
    function d(e, r) {
      for (var n = r.blocksPerLine, o = r.blocksPerColumn, a = new Int16Array(64), t = 0; t < o; t++) for (var i = 0; i < n; i++) m(r, h(r, t, i), a);
      return r.blockData;
    }
    function p(e, r, n) {
      function o(r) {
    ...
    return l.prototype = {
      parse: function (n) {
        ...
        function a() {
          ...
          var t = n.subarray(c, r);
          return c += t.length, t;
        }
        function t(e) {
          for (var r = Math.ceil(e.samplesPerLine / 8 / e.maxH), n = Math.ceil(e.scanLines / 8 / e.maxV), o = 0; o < e.components.length; o++) {
            R = e.components[o];
          ...
          switch (k) {
            ...
            case 65499:
              for (var y = o() + c - 2; c < y;) {
                ...
                if (D >> 4 == 0) for (C = 0; C < 64; C++) T[r[C]] = n[c++];else {
                  if (D >> 4 != 1) throw new e("DQT - invalid table spec");
                  for (C = 0; C < 64; C++) T[r[C]] = o();
                }
                h[15 & D] = T;
              }
              break;
            ...
            case 65474:
              ...
              o(), (i = {}).extended = 65473 === k, i.progressive = 65474 === k, i.precision = n[c++], i.scanLines = o(), i.samplesPerLine = o(), i.components = [], i.componentIds = {};
              var P,
                L = n[c++],
                A = 0,
                _ = 0;
            ...
            case 65476:
              ...
              for (g = 2; g < M;) {
                var Y = n[c++],
                  q = new Uint8Array(16),
                  S = 0;
                for (C = 0; C < 16; C++, c++) S += q[C] = n[c];
                var H = new Uint8Array(S);
                for (C = 0; C < S; C++, c++) H[C] = n[c];
                g += 17 + S, (Y >> 4 == 0 ? b : m)[15 & Y] = u(q, H);
              }
              break;
            case 65501:
              o(), s = o();
            ...
            case 65535:
              ...
              break;
            default:
              if (255 === n[c - 3] && n[c - 2] >= 192 && n[c - 2] <= 254) {
                c -= 3;
                break;
              }
      ...
      _getLinearizedBlockData: function (e, r) {
        var n,
          o,
          a,
          t,
          ...
          C = 4294967288;
        for (c = 0; c < p; c++) {
          for (o = (n = this.components[c]).scaleX * v, a = n.scaleY * m, d = c, h = n.output, t = n.blocksPerLine + 1 << 3, i = 0; i < e; i++) f = 0 | i * o, g[i] = (f & C) << 3 | 7 & f;
          for (s = 0; s < r; s++) for (u = t * ((f = 0 | s * a) & C) | (7 & f) << 3, i = 0; i < e; i++) k[d] = h[u + g[i]], d += p;
        }
...
}, void 0 !== (o = n()) && (r.exports = o);
const t = (0,_commonjsHelpers_js__WEBPACK_IMPORTED_MODULE_0__.g)(a.exports);
...
s.exports, r = s, void 0 !== (e = function () {
  function t() {
  ...
  return n.prototype = Object.create(e.prototype), n.prototype.getBits = function (t) {
    ...
    if (1 & n && (this.eof = !0), 0 != (n >>= 1)) {
      ...
      for (var m = (T = this.buffer) ? T.length : 0, k = this.bufferLength;;) {
        var w = this.getCode(a);
        if (w < 256) k + 1 >= m && (m = (T = this.ensureBuffer(k + 1)).length), T[k++] = w;else {
          if (256 == w) return void (this.bufferLength = k);
          var C = (w = r[w -= 257]) >> 16;
          C > 0 && (C = this.getBits(C)), g = (65535 & w) + C, w = this.getCode(h), (C = (w = i[w]) >> 16) > 0 && (C = this.getBits(C));
          var L = (65535 & w) + C;
          k + g >= m && (m = (T = this.ensureBuffer(k + g)).length);
          for (var S = 0; S < g; ++S, ++k) T[k] = T[k - L];
        }
      }
    } else {
      var A,
...
const f = (0,_commonjsHelpers_js__WEBPACK_IMPORTED_MODULE_0__.g)(s.exports);
...
let o = t = class extends _core_JSONSupport_js__WEBPACK_IMPORTED_MODULE_1__.JSONSupport {
  constructor() {
...
})], o.prototype, "name", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_2__.property)({
  json: {
    name: "WavelengthMin",
    read: {
      reader: n
...
})], o.prototype, "minWavelength", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_2__.property)({
  json: {
    name: "WavelengthMax",
    read: {
      reader: n
...
})], o.prototype, "maxWavelength", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_2__.property)({
  json: {
    name: "RadianceBias",
    read: {
      reader: n
...
})], o.prototype, "radianceBias", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_2__.property)({
  json: {
    name: "RadianceGain",
    read: {
      reader: n
...
})], o.prototype, "radianceGain", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_2__.property)({
  json: {
...
})], o.prototype, "reflectanceBias", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_2__.property)({
  json: {
...
})], o.prototype, "reflectanceGain", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_2__.property)({
  json: {
...
})], o.prototype, "solarIrradiance", void 0), o = t = (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_subclass_js__WEBPACK_IMPORTED_MODULE_6__.subclass)("esri.layers.support.RasterBandInfo")], o);
const s = o;
...
/* harmony import */ var _geometry_Extent_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../geometry/Extent.js */ 10465);
...
/* harmony import */ var _RasterBandInfo_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./RasterBandInfo.js */ 34806);
/* harmony import */ var _RasterSensorInfo_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./RasterSensorInfo.js */ 26304);
/* harmony import */ var _RasterStorageInfo_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./RasterStorageInfo.js */ 1137);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
*/
...
var h;
let u = h = class extends _core_JSONSupport_js__WEBPACK_IMPORTED_MODULE_1__.JSONSupport {
  constructor(t) {
  ...
  get bandInfos() {
    ...
    if (!t?.length || t.length < e) {
      const t = [];
      for (let o = 1; o <= e; o++) t.push(new _RasterBandInfo_js__WEBPACK_IMPORTED_MODULE_8__["default"]({
        name: "band_" + o
      }));
      return t;
    }
    const o = t.map(t => _RasterBandInfo_js__WEBPACK_IMPORTED_MODULE_8__["default"].fromJSON(t));
  ...
  get sensorInfo() {
    if (this.keyProperties?.SensorName) return _RasterSensorInfo_js__WEBPACK_IMPORTED_MODULE_9__["default"].fromJSON(this.keyProperties);
  }
  clone() {
    return new h({
      attributeTable: (0,_core_lang_js__WEBPACK_IMPORTED_MODULE_2__.clone)(this.attributeTable),
      bandCount: this.bandCount,
      colormap: (0,_core_lang_js__WEBPACK_IMPORTED_MODULE_2__.clone)(this.colormap),
      extent: (0,_core_lang_js__WEBPACK_IMPORTED_MODULE_2__.clone)(this.extent),
      nativePixelSize: (0,_core_lang_js__WEBPACK_IMPORTED_MODULE_2__.clone)(this.nativePixelSize),
      format: this.format,
      height: this.height,
      width: this.width,
      histograms: (0,_core_lang_js__WEBPACK_IMPORTED_MODULE_2__.clone)(this.histograms),
      keyProperties: (0,_core_lang_js__WEBPACK_IMPORTED_MODULE_2__.clone)(this.keyProperties),
      multidimensionalInfo: (0,_core_lang_js__WEBPACK_IMPORTED_MODULE_2__.clone)(this.multidimensionalInfo),
      noDataValue: this.noDataValue,
      pixelSize: (0,_core_lang_js__WEBPACK_IMPORTED_MODULE_2__.clone)(this.pixelSize),
      ...
      storageInfo: (0,_core_lang_js__WEBPACK_IMPORTED_MODULE_2__.clone)(this.storageInfo),
      transform: (0,_core_lang_js__WEBPACK_IMPORTED_MODULE_2__.clone)(this.transform)
    });
  }
};
...
})], u.prototype, "attributeTable", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  json: {
    write: !0
  }
})], u.prototype, "bandCount", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  readOnly: !0
})], u.prototype, "bandInfos", null), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  json: {
    write: !0
  }
})], u.prototype, "colormap", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  type: String,
  readOnly: !0
})], u.prototype, "dataType", null), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  type: _geometry_Extent_js__WEBPACK_IMPORTED_MODULE_6__["default"],
  json: {
    write: !0
  }
})], u.prototype, "extent", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  type: _geometry_Extent_js__WEBPACK_IMPORTED_MODULE_6__["default"],
  json: {
    write: !0
  }
})], u.prototype, "nativeExtent", null), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  json: {
    write: !0
  }
})], u.prototype, "nativePixelSize", null), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  json: {
    write: !0
  }
})], u.prototype, "format", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  json: {
    write: !0
  }
})], u.prototype, "height", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  json: {
    write: !0
  }
})], u.prototype, "width", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  json: {
    write: !0
  }
})], u.prototype, "hasMultidimensionalTranspose", null), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  json: {
    write: !0
  }
})], u.prototype, "histograms", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  json: {
    write: !0
  }
})], u.prototype, "keyProperties", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  json: {
    write: !0
  }
})], u.prototype, "multidimensionalInfo", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  json: {
    write: !0
  }
})], u.prototype, "noDataValue", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  json: {
    write: !0
  }
})], u.prototype, "pixelSize", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  json: {
    write: !0
  }
})], u.prototype, "pixelType", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)()], u.prototype, "isPseudoSpatialReference", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  readOnly: !0
})], u.prototype, "sensorInfo", null), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  type: _geometry_SpatialReference_js__WEBPACK_IMPORTED_MODULE_7__["default"],
  json: {
    write: !0
  }
})], u.prototype, "spatialReference", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  json: {
    write: !0
  }
})], u.prototype, "statistics", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  type: _RasterStorageInfo_js__WEBPACK_IMPORTED_MODULE_10__["default"],
  json: {
    write: !0
  }
})], u.prototype, "storageInfo", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  json: {
    write: !0
  }
})], u.prototype, "transform", void 0), u = h = (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_subclass_js__WEBPACK_IMPORTED_MODULE_5__.subclass)("esri.layers.support.RasterInfo")], u);
const m = u;
...
/* harmony import */ var _core_accessorSupport_decorators_writer_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../core/accessorSupport/decorators/writer.js */ 70425);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
*/
...
let u = a = class extends _core_JSONSupport_js__WEBPACK_IMPORTED_MODULE_1__.JSONSupport {
  constructor() {
...
})], u.prototype, "acquisitionDate", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_reader_js__WEBPACK_IMPORTED_MODULE_6__.reader)("acquisitionDate")], u.prototype, "readAcquisitionDate", null), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_writer_js__WEBPACK_IMPORTED_MODULE_8__.writer)("acquisitionDate")], u.prototype, "writeAcquisitionDate", null), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_2__.property)({
  json: {
    name: "CloudCover",
    read: {
      reader: n
...
})], u.prototype, "cloudCover", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_2__.property)({
  json: {
    name: "ProductName",
    write: !0
  }
})], u.prototype, "productName", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_2__.property)({
  json: {
    name: "SensorName",
    write: !0
  }
})], u.prototype, "sensorName", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_2__.property)({
  json: {
    name: "SensorAzimuth",
    read: {
      reader: n
...
})], u.prototype, "sensorAzimuth", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_2__.property)({
  json: {
...
})], u.prototype, "sensorElevation", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_2__.property)({
  json: {
    name: "SunAzimuth",
    read: {
      reader: n
...
})], u.prototype, "sunAzimuth", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_2__.property)({
  json: {
    name: "SunElevation",
    read: {
      reader: n
...
})], u.prototype, "sunElevation", void 0), u = a = (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_subclass_js__WEBPACK_IMPORTED_MODULE_7__.subclass)("esri.layers.support.RasterSensorInfo")], u);
const p = u;
...
var p;
let l = p = class extends _core_JSONSupport_js__WEBPACK_IMPORTED_MODULE_1__.JSONSupport {
  constructor() {
  ...
  clone() {
    return new p({
      ...
      origin: (0,_core_lang_js__WEBPACK_IMPORTED_MODULE_2__.clone)(this.origin),
      firstPyramidLevel: this.firstPyramidLevel,
      maximumPyramidLevel: this.maximumPyramidLevel,
      pyramidResolutions: (0,_core_lang_js__WEBPACK_IMPORTED_MODULE_2__.clone)(this.pyramidResolutions),
      ...
      tileInfo: (0,_core_lang_js__WEBPACK_IMPORTED_MODULE_2__.clone)(this.tileInfo),
      transposeInfo: (0,_core_lang_js__WEBPACK_IMPORTED_MODULE_2__.clone)(this.transposeInfo),
      blockBoundary: (0,_core_lang_js__WEBPACK_IMPORTED_MODULE_2__.clone)(this.blockBoundary)
    });
  }
};
(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
...
})], l.prototype, "blockWidth", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  type: Number,
  json: {
    write: !0
  }
})], l.prototype, "blockHeight", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  type: String,
  json: {
    write: !0
  }
})], l.prototype, "compression", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  type: _geometry_Point_js__WEBPACK_IMPORTED_MODULE_6__["default"],
  json: {
    write: !0
  }
})], l.prototype, "origin", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  type: Number,
  json: {
    write: !0
  }
})], l.prototype, "firstPyramidLevel", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  type: Number,
  json: {
    write: !0
  }
})], l.prototype, "maximumPyramidLevel", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  json: {
    write: !0
  }
})], l.prototype, "pyramidResolutions", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  type: Number,
  json: {
    write: !0
  }
})], l.prototype, "pyramidScalingFactor", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  type: Number,
  json: {
    write: !0
  }
})], l.prototype, "pyramidBlockWidth", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  type: Number,
  json: {
    write: !0
  }
})], l.prototype, "pyramidBlockHeight", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  type: Boolean,
  json: {
    write: !0
  }
})], l.prototype, "isVirtualTileInfo", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)({
  json: {
    write: !0
  }
})], l.prototype, "tileInfo", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)()], l.prototype, "transposeInfo", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_3__.property)()], l.prototype, "blockBoundary", void 0), l = p = (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_subclass_js__WEBPACK_IMPORTED_MODULE_5__.subclass)("esri.layers.support.RasterStorageInfo")], l);
const n = l;
...
/* harmony import */ var _chunks_Zlib_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../chunks/Zlib.js */ 78902);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
*/
...
class i {
  ...
  decode(n, s, r) {
    if (!n || n.byteLength < 10) throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_0__["default"]("imagecanvasdecoder: decode", "required a valid encoded data as input.");
    let {
      width: c = 0,
      height: h = 0,
      format: o
    ...
    if (l && (!c || !h)) throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_0__["default"]("imagecanvasdecoder: decode", "image width and height are needed to apply jpeg mask directly to canvas");
    return new Promise((t, d) => {
      ...
      let _;
      m.src = v, m.onload = () => {
        if (URL.revokeObjectURL(v), (0,_core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_1__.isAborted)(r)) return void d((0,_core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_1__.createAbortError)());
  ...
  static _getMask(t, e) {
    ...
    try {
      ...
      if (r += 2, r < i.length - 1) {
        const t = new _chunks_Zlib_js__WEBPACK_IMPORTED_MODULE_2__.Z(i.subarray(r)).getBytes();
...
/* harmony export */ });
/* harmony import */ var _chunks_Jpg_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../chunks/Jpg.js */ 16095);
/* harmony import */ var _chunks_Zlib_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../chunks/Zlib.js */ 78902);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
*/
...
class r {
  static decode(r, n = !1) {
    const s = new Uint8Array(r),
      o = new _chunks_Jpg_js__WEBPACK_IMPORTED_MODULE_0__.J();
    o.parse(s);
    const {
        width: a,
        height: i,
    ...
    if (!n && h < s.length - 1) try {
      const t = new _chunks_Zlib_js__WEBPACK_IMPORTED_MODULE_1__.Z(s.subarray(h)).getBytes();
      g = new Uint8Array(c);
      let r = 0;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "decode": () => (/* binding */ c),
/* harmony export */   "getBlobInfo": () => (/* binding */ h),
/* harmony export */   "isLoaded": () => (/* binding */ o),
/* harmony export */   "load": () => (/* binding */ a),
/* harmony export */   "pixelTypeInfoMap": () => (/* binding */ t)
/* harmony export */ });
/* harmony import */ var _assets_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../assets.js */ 74792);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
*/
...
let n = null,
  r = !1;
function a() {
  return n || (n = __webpack_require__.e(/*! import() */ "node_modules_arcgis_core_chunks_lerc-wasm_js").then(__webpack_require__.bind(__webpack_require__, /*! ../../../chunks/lerc-wasm.js */ 78957)).then(e => e.l).then(({
    default: t
  }) => t({
    locateFile: t => (0,_assets_js__WEBPACK_IMPORTED_MODULE_0__.getAssetUrl)(`esri/layers/support/rasterFormats/${t}`)
  })).then(e => {
    u(e), r = !0;
  }), n);
}
...
/* harmony export */   "getFormat": () => (/* binding */ P)
/* harmony export */ });
...
/* harmony import */ var _ImageCanvasDecoder_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ImageCanvasDecoder.js */ 71752);
/* harmony import */ var _JpgPlus_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./JpgPlus.js */ 69249);
/* harmony import */ var _Lerc_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Lerc.js */ 43707);
/* harmony import */ var _Lzw_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Lzw.js */ 15608);
/* harmony import */ var _pixelRangeUtils_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./pixelRangeUtils.js */ 79092);
/* harmony import */ var _chunks_Zlib_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../chunks/Zlib.js */ 78902);
/* harmony import */ var _Raw_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Raw.js */ 21631);
/* harmony import */ var _TiffDecoder_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./TiffDecoder.js */ 27986);
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./utils.js */ 48957);
...
var f = function (t) {
  ...
  return o.load = function (t, e, a) {
    ...
    var e, a, i, s, r, n, o, h, l, p, d, u, f, m, g, w, y, b, x, k, T, I, C;
    if (null == t && (t = this.imgData), 0 === t.length) return new Uint8Array(0);
    for (t = (t = new _chunks_Zlib_js__WEBPACK_IMPORTED_MODULE_9__.Z(t)).getBytes(), w = (u = this.pixelBitlength / 8) * this.width, f = new Uint8Array(w * this.height), n = t.length, g = 0, m = 0, a = 0; m < n;) {
      switch (t[m++]) {
        case 0:
          for (s = x = 0; x < w; s = x += 1) f[a++] = t[m++];
          break;
        case 1:
        ...
        case 3:
          ...
          break;
        case 4:
          for (s = C = 0; C < w; s = C += 1) e = t[m++], i = (s - s % u) / u, r = s < u ? 0 : f[a - u], 0 === g ? y = b = 0 : (y = f[(g - 1) * w + i * u + s % u], b = i && f[(g - 1) * w + (i - 1) * u + s % u]), o = r + y - b, h = Math.abs(o - r), p = Math.abs(o - y), d = Math.abs(o - b), l = h <= p && h <= d ? r : p <= d ? y : b, f[a++] = (e + l) % 256;
          break;
        default:
...
function _g() {
  _g = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (e, i) {
    if (!_utils_js__WEBPACK_IMPORTED_MODULE_12__.isPlatformLittleEndian) throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_1__["default"]("rasterCoded:decode", "lerc decoder is not supported on big endian platform");
    yield (0,_Lerc_js__WEBPACK_IMPORTED_MODULE_6__.load)();
    const {
        offset: s
      } = i,
      {
        ...
        pixels: m,
        mask: g
      } = (0,_Lerc_js__WEBPACK_IMPORTED_MODULE_6__.decode)(e, {
        inputOffset: s,
        returnInterleaved: i.returnInterleaved
      }),
      w = new _PixelBlock_js__WEBPACK_IMPORTED_MODULE_3__["default"]({
        width: o,
        height: h,
    ...
    return l?.length || w.updateStatistics(), w;
  });
  return _g.apply(this, arguments);
}
function w(_x3, _x4) {
...
function _w() {
  _w = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, i) {
    const s = yield (0,_TiffDecoder_js__WEBPACK_IMPORTED_MODULE_11__.decode)(t, {
      ...i,
      noDataValue: null
    });
    (0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.assertIsSome)(s);
    const r = new _PixelBlock_js__WEBPACK_IMPORTED_MODULE_3__["default"]({
      width: s.width,
      height: s.height,
      pixels: s.pixels,
...
function _y() {
  _y = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const i = yield (0,_TiffDecoder_js__WEBPACK_IMPORTED_MODULE_11__.decodeTileOrStrip)(t, e.customOptions),
      s = new _PixelBlock_js__WEBPACK_IMPORTED_MODULE_3__["default"]({
        width: i.width,
        height: i.height,
        pixels: i.pixels,
...
function b(t, e) {
  const i = e.pixelType || "u8",
    s = _PixelBlock_js__WEBPACK_IMPORTED_MODULE_3__["default"].getPixelArrayConstructor(i),
  ...
  const h = new _PixelBlock_js__WEBPACK_IMPORTED_MODULE_3__["default"]({
    width: e.width || 1,
...
function x(t, e) {
  return b(new _chunks_Zlib_js__WEBPACK_IMPORTED_MODULE_9__.Z(new Uint8Array(t)).getBytes(), e);
}
function k(t, e) {
  return b((0,_Lzw_js__WEBPACK_IMPORTED_MODULE_7__.decode)(t, e.offset, e.eof, !e.isInputBigEndian), e);
}
function T(t, e, i) {
  const {
      pixelTypeCtor: s
    } = D(e.pixelType),
    r = (0, _Raw_js__WEBPACK_IMPORTED_MODULE_10__["default"].decode)(t, {
      width: e.width,
      height: e.height,
      pixelType: s,
      format: i
    }),
    n = new _PixelBlock_js__WEBPACK_IMPORTED_MODULE_3__["default"]({
      width: e.width,
      height: e.height,
      pixels: r.pixels,
...
function I(t, e) {
  const i = _JpgPlus_js__WEBPACK_IMPORTED_MODULE_5__["default"].decode(t, e.hasNoZlibMask ?? void 0),
    r = new _PixelBlock_js__WEBPACK_IMPORTED_MODULE_3__["default"]({
      width: i.width,
      height: i.height,
      pixels: i.pixels,
      pixelType: "U8",
...
function C(t, e) {
  ...
  const u = new _PixelBlock_js__WEBPACK_IMPORTED_MODULE_3__["default"]({
    width: r,
    height: n,
    pixels: [],
    pixelType: "U8",
...
function v(_x7, _x8, _x9, _x10) {
  return _v.apply(this, arguments);
}
function _v() {
  _v = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, s, r) {
    const n = new _ImageCanvasDecoder_js__WEBPACK_IMPORTED_MODULE_4__["default"](),
      o = {
        applyJpegMask: !1,
        format: e,
        ...s
      },
      h = yield n.decode(t, o, r),
      c = new _PixelBlock_js__WEBPACK_IMPORTED_MODULE_3__["default"](h);
...
function O(t, e = 1) {
  ...
  let p,
    ...
    g,
    w = null;
  const y = _PixelBlock_js__WEBPACK_IMPORTED_MODULE_3__["default"].getPixelArrayConstructor(t.pixelType);
  if (0 === e) {
    for (p = 0; p < o; p++) {
...
function _j() {
  _j = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (e, a = {}, i) {
    ...
    if (!("bsq" !== s && "bip" !== s || null != a.width && null != a.height)) throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_1__["default"]("rasterCodec:decode", "requires width and height in options parameter.");
    if ("tiff" === s && a.customOptions) return y(e, a);
    if ((!s || "bsq" !== s && "bip" !== s && "deflate" !== s && "lzw" !== s) && (s = U(e)), a.useCanvas && m.has(s)) return v(e, s, a, i);
    const r = A(s);
    a.isPoint && (null != (a = {
      ...a
    }).width && a.width++, null != a.height && a.height++);
    const n = yield r(e, a);
    return n ? ("jpg" !== s && null != a.noDataValue && 1 === n.depthCount && (0,_pixelRangeUtils_js__WEBPACK_IMPORTED_MODULE_8__.convertNoDataToMask)(n, a.noDataValue, {
      customFloatTolerance: a.tolerance
    }), a.isPoint && O(n), n) : n;
  });
  return _j.apply(this, arguments);
}
...
/* harmony export */   "decodeTileOrStrip": () => (/* binding */ H),
/* harmony export */   "getImageInfo": () => (/* binding */ R),
/* harmony export */   "getMaskIFDs": () => (/* binding */ N),
/* harmony export */   "getPyramidIFDs": () => (/* binding */ U),
/* harmony export */   "isBSQConfig": () => (/* binding */ D),
/* harmony export */   "parseFieldValues": () => (/* binding */ L),
/* harmony export */   "parseHeader": () => (/* binding */ k),
/* harmony export */   "parseIFD": () => (/* binding */ B),
/* harmony export */   "parseSignature": () => (/* binding */ F)
/* harmony export */ });
/* harmony import */ var _home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 71670);
/* harmony import */ var _rasterDatasets_byteStreamUtils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../rasterDatasets/byteStreamUtils.js */ 25791);
/* harmony import */ var _chunks_Jpg_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../chunks/Jpg.js */ 16095);
/* harmony import */ var _Lerc_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Lerc.js */ 43707);
/* harmony import */ var _Lzw_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Lzw.js */ 15608);
/* harmony import */ var _pixelRangeUtils_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pixelRangeUtils.js */ 79092);
/* harmony import */ var _TiffTags_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./TiffTags.js */ 83429);
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils.js */ 48957);
/* harmony import */ var _chunks_Zlib_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../chunks/Zlib.js */ 78902);
...
function p(e, t, n, a = 0, i = _TiffTags_js__WEBPACK_IMPORTED_MODULE_6__["default"].tiffTags, s = 4) {
  const l = 8 === s,
  ...
  let T,
    ...
    m = 0;
  for (let S = 0; S < o; S++) {
    I = new DataView(e, g + f * S, f), w = I.getUint16(0, t), p = I.getUint16(2, t), d = _TiffTags_js__WEBPACK_IMPORTED_MODULE_6__["default"].getTagName(w, i);
    const n = [];
    2 === s ? (y = I.getUint16(4, t), m = I.getUint16(6, t)) : 4 === s ? (y = I.getUint32(4, t), m = I.getUint32(8, t)) : 8 === s && (y = v(I, 4, t, !0), m = v(I, 12, t, !0), n.push(I.getUint32(12, t)), n.push(I.getUint32(16, t))), T = {
      id: w,
      type: p,
      valueCount: y,
      valueOffset: m,
...
const y = (e, t) => (0,_Lerc_js__WEBPACK_IMPORTED_MODULE_3__.decode)(e, {
  inputOffset: t
}).pixels[0];
function m(e, t) {
...
function S(e, n, a) {
  const i = new _chunks_Jpg_js__WEBPACK_IMPORTED_MODULE_2__.J();
  i.parse(e), i.colorTransform = 6 === a ? -1 : 0;
  const s = i.getData(i.width, i.height, 1 !== n && 4 !== n);
  return new Uint8Array(s.buffer);
}
function A(e) {
  const t = new _chunks_Zlib_js__WEBPACK_IMPORTED_MODULE_8__.Z(e).getBytes(),
...
function _M() {
  _M = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (e, t, a, s, r) {
    const o = _utils_js__WEBPACK_IMPORTED_MODULE_7__.isPlatformLittleEndian === t,
      f = d(a, "BITSPERSAMPLE"),
      u = d(a, "SAMPLESPERPIXEL") ?? 1,
      c = d(a, "PHOTOMETRICINTERPRETATION"),
      E = d(a, "SAMPLEFORMAT") ?? 1,
      T = h(E, f),
      I = d(a, "COMPRESSION") ?? 1,
      w = g(T);
    let p, M, P;
    if (34887 === I) return yield (0,_Lerc_js__WEBPACK_IMPORTED_MODULE_3__.load)(), y(e, s);
    if (1 === I) p = e.slice(s, s + r), M = new Uint8Array(p);else if (8 === I || 32946 === I) M = new Uint8Array(e, s, r), M = A(M), p = M.buffer;else if (6 === I) M = new Uint8Array(e, s, r), M = S(M, u, c), p = M.buffer;else if (7 === I) {
      ...
      M = S(M, u, c), p = M.buffer;
    } else {
      if (5 !== I) throw new Error("tiff-decode: unsupport compression " + I);
      M = (0,_Lzw_js__WEBPACK_IMPORTED_MODULE_4__.decode)(e, s, r, t), p = M.buffer;
    }
    if (p = m(p, f), "u8" === T || "s8" === T || o) P = new w(p);else {
    ...
    const b = d(a, "PREDICTOR") ?? 1,
      O = d(a, "TILEWIDTH"),
      x = d(a, "TILELENGTH");
    if (b > 1 && (5 === I || 8 === I || 32946 === I) && O && x) {
      const e = D(a),
        t = new w(P.length);
      t.set(P), P = W(t, x, O, 3 === E && 3 === b, e ? 1 : u);
    }
    return P;
  });
  return _M.apply(this, arguments);
...
function _P() {
  _P = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (e, t, n) {
    ...
    const i = I(n, "TILEBYTECOUNTS"),
      ...
      h = s * r,
      E = d(n, "BITSPERSAMPLE"),
      T = 34887 === (d(n, "COMPRESSION") ?? 1),
      w = g(l),
      p = [];
    for (let g = 0; g < c; g++) p.push(new w(h));
    let y, m, S, A, P, b, O, x, L, U, N, k, C;
    ...
    if (E % 8 == 0) if (T && u && c > 1) {
      ...
      for (y = 0; y < l; y++) {
        b = Math.floor(y / G) * f, O = y % G * o, x = b * s + O;
        for (let l = 0; l < c; l++) {
          const u = y * c + l;
          for (0 === i[u] ? (S = null, F = !0) : S = yield M(e, t.littleEndian, n, a[u], i[u]), U = 0, L = x, k = Math.min(o, s - O), N = Math.min(f, r - b), C = p[l], A = 0; A < N; A++) for (L = x + A * s, U = A * o, P = 0; P < k; P++, L++, U++) S ? C[L] = S[U] : v[L] = 0;
        }
      }
    } else for (y = 0; y < a.length; y++) for (b = Math.floor(y / G) * f, O = y % G * o, x = b * s + O, 0 === i[y] ? (S = null, F = !0) : S = yield M(e, t.littleEndian, n, a[y], i[y]), U = 0, L = x, k = Math.min(o, s - O), N = Math.min(f, r - b), m = 0; m < c; m++) if (C = p[m], u || T) for (A = 0; A < N; A++) for (L = x + A * s, U = o * f * m + A * o, P = 0; P < k; P++, L++, U++) S ? C[L] = S[U] : v[L] = 0;else for (A = 0; A < N; A++) for (L = x + A * s, U = A * o * c + m, P = 0; P < k; P++, L++, U += c) S ? C[L] = S[U] : v[L] = 0;
    return {
      width: s,
      height: r,
      pixelType: l,
...
const b = (e, t, n) => {
    const a = _utils_js__WEBPACK_IMPORTED_MODULE_7__.isPlatformLittleEndian === t.littleEndian,
      s = I(n, "STRIPOFFSETS");
    ...
    if (E % 8 == 0) for (P = 0; P < s.length; P++) {
      if (L = P * (y * r) * u, C = (P + 1) * y > o ? o - P * y : y, "u8" === f || "s8" === f || a) 8 === M || 32946 === M ? (U = new Uint8Array(e, s[P], p[P]), U = A(U), D = U.buffer) : 6 === M ? (U = new Uint8Array(e, s[P], p[P]), U = S(U, u, c), D = U.buffer) : 5 === M ? (U = (0,_Lzw_js__WEBPACK_IMPORTED_MODULE_4__.decode)(e, s[P], p[P], t.littleEndian), D = U.buffer) : (p[P] !== C * r * u * E / 8 && console.log("strip byte counts is different than expected"), D = e.slice(s[P], s[P] + p[P])), D = m(D, E), x = new T(D);else {
        switch (6 === M || 8 === M || 32946 === M ? (U = new Uint8Array(e, s[P], p[P]), N = A(U), D = N.buffer) : (p[P] !== C * r * u * E / 8 && console.log("strip byte counts is different than expected"), D = new ArrayBuffer(p[P]), U = new Uint8Array(e, s[P], p[P]), N = new Uint8Array(D)), f) {
          case "u16":
          case "s16":
            for (O = 0; O < U.length; O += 2) N[O] = U[O + 1], N[O + 1] = U[O];
            break;
          case "u32":
          case "s32":
          case "f32":
            for (O = 0; O < U.length; O += 4) N[O] = U[O + 3], N[O + 1] = U[O + 2], N[O + 2] = U[O + 1], N[O + 3] = U[O];
        }
        D = m(D, E), x = new T(D);
      }
      w.set(x, L);
    ...
    const G = [];
    if (1 === u) G.push(w);else for (P = 0; P < u; P++) {
      for (k = new T(h), b = 0; b < h; b++) k[b] = w[b * u + P];
      G.push(k);
    }
    return {
      width: r,
...
function L(e, t, n, a = 0, i = !1, s = 4) {
  ...
  if (T <= d) {
    if (!t) if (d <= 32) o >>>= 32 - T;else {
      const e = p?.length ? p[0] : o >>> 0,
        t = p?.length ? p[1] : Math.round((o - e) / u);
      T <= 32 ? (o = e >>> 32 - T, p[0] = o) : (o = e * 2 ** (32 - T) + (t >>> 32 - T), p[0] = e, p[1] = t >>> 32 - T);
    }
...
function R(e) {
  ...
  let S = !0,
    A = "";
  c.has(y) || (S = !1, A += "unsupported tag compression " + y), o > 3 && (S = !1, A += "unsupported tag sampleFormat " + o), 1 !== r && 2 !== r && 4 !== r && r % 8 != 0 && (S = !1, A += "unsupported tag bitsPerSample " + r);
  ...
  if (O && b && b.length >= 6 ? (k = [O[0], 0, b[3] - b[0] * O[0], 0, -Math.abs(O[1]), b[4] - b[1] * O[1]], G && (k[2] -= .5 * k[0] + .5 * k[1], k[5] -= .5 * k[3] + .5 * k[4])) : L && 16 === L.length && (k = G ? [L[0], L[1], L[3] - .5 * L[0], L[4], L[5], L[7] - .5 * L[5]] : [L[0], L[1], L[3], L[4], L[5], L[7]]), k) {
    const e = [{
      x: 0,
      y: s
    }, {
  ...
  let B, W, H, Y, _;
  if (F.length > 0) {
    H = Math.round(Math.log(i / d(F[0], "IMAGEWIDTH")) / Math.LN2);
  ...
  return {
    ...
    compression: m,
    noData: p,
    hasMaskBand: N(e).length === F.length + 1,
    isSupported: S,
    message: A,
    extent: C,
...
function k(e) {
  ...
  const s = [];
  do {
    const a = B(e, t, i, 0, _TiffTags_js__WEBPACK_IMPORTED_MODULE_6__["default"].tiffTags, n ? 8 : 4);
    if (!a.success) break;
...
function B(t, n, a, i = 0, s = _TiffTags_js__WEBPACK_IMPORTED_MODULE_6__["default"].tiffTags, l = 4) {
  const o = p(t, n, a, i, s, l);
  let f;
  const u = o.ifd;
  if (u) {
    if (_TiffTags_js__WEBPACK_IMPORTED_MODULE_6__["default"].ifdTags.forEach((e, a) => {
      u.has(a) && (f = u.get(a), f.data = p(t, n, f.valueOffset - i, i, e).ifd);
    }), u.has("GEOKEYDIRECTORY")) {
      f = u.get("GEOKEYDIRECTORY");
      const e = f.values;
      if (e && e.length > 4) {
        const a = e[0] + "." + e[1] + "." + e[2];
        f.data = p(t, n, f.valueOffset + 6 - i, i, _TiffTags_js__WEBPACK_IMPORTED_MODULE_6__["default"].geoKeys, 2).ifd, f.data && f.data.set("GEOTIFFVersion", {
          id: 0,
          type: 2,
          valueCount: 1,
          valueOffset: null,
    ...
    if (u.has("XMP")) {
      f = u.get("XMP");
      const t = f.values;
      "number" == typeof t[0] && 7 === f.type && (f.values = [(0,_rasterDatasets_byteStreamUtils_js__WEBPACK_IMPORTED_MODULE_1__.bytesToUTF8)(new Uint8Array(t))]);
    }
  }
  return o;
}
...
function _H() {
  _H = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (e, t) {
    const {
        headerInfo: n,
        ifd: a,
        offsets: i,
    ...
    const A = 34887 === w;
    for (let s = 0; s < c; s++) {
      if (y = new E(p), l.length === c) S = l[s], S.length === p && (y = S);else if (S.length) if (o || A) y = S.length === p ? S : S.slice(p * s, p * (s + 1));else for (let e = 0; e < p; e++) y[e] = S[e * c + s];
      m.push(y);
    }
    const P = n.noData ? n.noData[0] : t.noDataValue,
      b = n.metadata ? n.metadata.statistics : null,
      x = b ? b.map(e => e.min) : null,
      L = b ? b.map(e => e.max) : null,
      R = {
        pixelType: u,
        width: T,
        height: I,
    ...
    return null != P ? (0,_pixelRangeUtils_js__WEBPACK_IMPORTED_MODULE_5__.convertNoDataToMask)(R, P) : x && L && t.applyMinMaxConstraint && (R.mask = O(m, x, L)), R;
  });
  return _H.apply(this, arguments);
}
function Y(_x11) {
...
function _Y() {
  _Y = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (e, t = {}) {
    ...
    const f = -1 === n ? i[i.length - 1] : i[n],
      u = r ?? t.noDataValue;
    return o = a.tileWidth ? yield P(e, a, f) : b(e, a, f), o ? (null != u && (0,_pixelRangeUtils_js__WEBPACK_IMPORTED_MODULE_5__.convertNoDataToMask)(o, u), o) : o;
  });
  return _Y.apply(this, arguments);
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "computeGammaCorrection": () => (/* binding */ x),
/* harmony export */   "computeGammaValues": () => (/* binding */ f),
/* harmony export */   "computeStatisticsHistograms": () => (/* binding */ m),
/* harmony export */   "createContrastBrightnessLUT": () => (/* binding */ l),
/* harmony export */   "createHistogramEqualizationLUT": () => (/* binding */ r),
/* harmony export */   "createStretchLUT": () => (/* binding */ a),
/* harmony export */   "estimateStatisticsFromHistograms": () => (/* binding */ g),
/* harmony export */   "estimateStatisticsHistograms": () => (/* binding */ h),
/* harmony export */   "getStretchCutoff": () => (/* binding */ p),
/* harmony export */   "stretch": () => (/* binding */ M)
/* harmony export */ });
...
/* harmony import */ var _rasterFormats_pixelRangeUtils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../rasterFormats/pixelRangeUtils.js */ 79092);
/* harmony import */ var _renderers_support_stretchRendererUtils_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../renderers/support/stretchRendererUtils.js */ 60996);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
*/
...
function r(t, n = 256) {
  ...
  const {
    ...
    i = new Uint8Array(s),
    o = e.reduce((t, s) => t + s / n, 0);
  let r = 0,
    a = 0,
    l = 0,
    f = o;
  for (let u = 0; u < s; u++) if (l += e[u], !(u < s - 1 && l + e[u + 1] < f)) {
    for (; r < n - 1 && f < l;) r++, f += o;
    for (let t = a; t <= u; t++) i[t] = r;
    a = u + 1;
  }
  for (let u = a; u < s; u++) i[u] = n - 1;
  return i;
}
function a(t) {
  const {
  ...
  const g = [],
    p = [],
    d = a - r;
  for (u = 0; u < f; u++) p[u] = s[u] - n[u], g[u] = 0 === p[u] ? 0 : d / p[u];
  let M;
  const y = [];
  let b, k, v;
  if (e && e.length >= f) {
    ...
    for (u = 0; u < f; u++) {
      for (v = [], c = 0; c < h; c++) if (0 !== p[u]) {
        if (b = c + m, M = (b - n[u]) / p[u], k = 1, e[u] > 1 && (k -= (1 / d) ** (M * t[u])), b < s[u] && b > n[u]) {
          const t = k * d * M ** (1 / e[u]) + r;
          v[c] = "floor" === o ? Math.floor(t) : "round" === o ? Math.round(t) : t;
        } else b >= s[u] ? v[c] = a : v[c] = r;
      } else v[c] = r;
      y[u] = v;
    }
  } else for (u = 0; u < f; u++) {
    for (v = [], c = 0; c < h; c++) if (b = c + m, b <= n[u]) v[c] = r;else if (b >= s[u]) v[c] = a;else {
      const t = (b - n[u]) * g[u] + r;
      v[c] = "floor" === o ? Math.floor(t) : "round" === o ? Math.round(t) : t;
    }
    y[u] = v;
...
function l(t, n) {
  const s = Math.min(Math.max(t, -100), 100),
    e = Math.min(Math.max(n ?? 0, -100), 100),
    i = 255,
    o = 128;
  let r = 0,
    a = 0;
  const l = new Uint8Array(256);
  for (r = 0; r < 256; r++) s > 0 && s < 100 ? a = (200 * r - 100 * i + 2 * i * e) / (2 * (100 - s)) + o : s <= 0 && s > -100 ? a = (200 * r - 100 * i + 2 * i * e) * (100 + s) / 2e4 + o : 100 === s ? (a = 200 * r - 100 * i + (i + 1) * (100 - s) + 2 * i * e, a = a > 0 ? i : 0) : -100 === s && (a = o), l[r] = a > i ? i : a < 0 ? 0 : a;
  return l;
}
function f(t, n, s) {
  const e = [];
  for (let i = 0; i < n.length; i++) {
    ...
    let f = l ?? 0;
    "u8" !== t && (f = 255 * (f - r) / (a - r)), s && (f *= o[i]), e.push(u(f));
  }
  return e;
}
function u(t) {
...
function c(t, n, s, e) {
  ...
  for (let w = 0; w < u; w++) {
    ...
    if (!n || n[w]) {
      m.push(s);
      const t = (c.get(s) ?? 0) + 1;
      c.set(s, t), t > f && (f = t, l = s), i = s < i ? s : i, o = s > o ? s : o, r += s, a++;
    }
  }
  if (0 === a) return {
    statistics: {
  ...
  if (["u8", "s8", "u4", "u2", "u1"].includes(s)) {
    const s = o - i + 1,
      e = new Uint32Array(s);
    for (let o = 0; o < u; o++) n && !n[o] || e[t[o] - i]++;
    return {
      statistics: M,
      histogram: {
        min: i - .5,
...
function h(t) {
  ...
  const m = [],
    h = [];
  let g, p, d, x, M, y, b, k, v, w;
  const z = 256;
  for (u = 0; u < r; u++) {
    g = new Uint32Array(z), d = n[u];
    const r = e?.[u] ?? s;
    if ("u8" === i) {
      if (a = -.5, l = 255.5, r) for (c = 0; c < o; c++) r[c] && g[d[c]]++;else for (c = 0; c < o; c++) g[d[c]]++;
    } else {
      let n = !1;
      t.statistics || (t.updateStatistics(), n = !0);
      const s = t.statistics;
      if (a = s[u].minValue, l = s[u].maxValue, f = (l - a) / z, 0 === f) {
        !s || t.validPixelCount || n || t.updateStatistics();
        const e = (t.validPixelCount || t.width * t.height) / z;
        for (let t = 0; t < z; t++) g[t] = Math.round(e * (t + 1)) - Math.round(e * t);
      } else {
        for (p = new Uint32Array(z + 1), c = 0; c < o; c++) r && !r[c] || p[Math.floor((d[c] - a) / f)]++;
        for (c = 0; c < z - 1; c++) g[c] = p[c];
        g[z - 1] = p[z - 1] + p[z];
      }
    }
    for (m.push({
      ...
      size: z,
      counts: g
    }), x = 0, M = 0, k = 0, c = 0; c < z; c++) x += g[c], M += c * g[c];
    for (v = M / x, c = 0; c < z; c++) k += g[c] * (c - v) ** 2;
    w = Math.sqrt(k / (x - 1)), f = (l - a) / z, y = (v + .5) * f + a, b = w * f, h.push({
      min: a,
      max: l,
      avg: y,
      stddev: b
...
function p(n, i) {
  ...
  let u = null,
    c = null,
    m = n.stretchType;
  if ("number" == typeof m && (m = _renderers_support_stretchRendererUtils_js__WEBPACK_IMPORTED_MODULE_3__.stretchTypeFunctionEnum[m]), n.dra) {
  ...
  const [A, U] = (0,_rasterFormats_pixelRangeUtils_js__WEBPACK_IMPORTED_MODULE_2__.getPixelValueRange)(f.pixelType);
  if (!u?.length) {
  ...
  switch (m) {
    ...
    case "histogramEqualization":
      for ((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_0__.assertIsSome)(c), C = 0; C < g; C++) p[C] = c[C].min, x[C] = c[C].max;
      break;
    case "percentClip":
      for ((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_0__.assertIsSome)(c), C = 0; C < c.length; C++) {
  ...
  let T, q, P;
  "histogramEqualization" === m ? ((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_0__.assertIsSome)(c), q = c[0].size || 256, T = 0, l && (P = c.map(t => r(t)))) : (q = n.max || 255, T = n.min || 0);
  return d({
    minCutOff: p,
    maxCutOff: x,
    outMax: q,
...
function d(t, n) {
  ...
  return e.length === n.length || e.length <= s ? t : {
    minCutOff: n.map(t => e[t]),
...
function x(t, n) {
  ...
  for (let e = 0; e < t; e++) n[e] > 1 ? n[e] > 2 ? s[e] = 6.5 + (n[e] - 2) ** 2.5 : s[e] = 6.5 + 100 * (2 - n[e]) ** 4 : s[e] = 1;
  return s;
}
function M(t, s) {
  ...
  const {
    ...
    m = s.outMax || 255,
    h = o * r,
    g = s.outputPixelType || "u8",
    p = t.pixels.map(() => _PixelBlock_js__WEBPACK_IMPORTED_MODULE_1__["default"].createEmptyBand(g, h)),
    d = p.length,
    M = m - c,
    y = [],
    b = [];
  ...
  if (v) {
    ...
    for (let n = 0; n < d; n++) {
      const s = i?.[n] ?? e;
      for (let e = 0; e < h; e++) if (null == s || s[e]) {
        if (0 === b[n]) {
          p[n][e] = c;
          continue;
        }
        const s = a[n][e],
          i = (s - l[n]) / b[n];
        let o = 1;
        if (u[n] > 1 && (o -= (1 / M) ** (i * t[n])), s < f[n] && s > l[n]) {
          const t = o * M * i ** (1 / u[n]) + c;
          p[n][e] = w ? Math.floor(t) : k ? Math.round(t) : t;
        } else s >= f[n] ? p[n][e] = m : p[n][e] = c;
      }
    }
  } else for (let n = 0; n < d; n++) {
    const t = i?.[n] ?? e;
    for (let s = 0; s < h; s++) if (null == t || t[s]) {
      const t = a[n][s];
      if (t < f[n] && t > l[n]) {
        const e = (t - l[n]) * y[n] + c;
        p[n][s] = w ? Math.floor(e) : k ? Math.round(e) : e;
      } else t >= f[n] ? p[n][s] = m : p[n][s] = c;
    }
  }
  const z = new _PixelBlock_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
    width: o,
    height: r,
    mask: e,
    bandMasks: i,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "aspect": () => (/* binding */ h),
/* harmony export */   "calculateHillshadeParams": () => (/* binding */ n),
/* harmony export */   "curvature": () => (/* binding */ u),
/* harmony export */   "gcsFactor": () => (/* binding */ s),
/* harmony export */   "hillshade": () => (/* binding */ o),
/* harmony export */   "slope": () => (/* binding */ c),
/* harmony export */   "tintHillshade": () => (/* binding */ r)
/* harmony export */ });
/* harmony import */ var _PixelBlock_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../PixelBlock.js */ 53416);
/* harmony import */ var _pixelUtils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pixelUtils.js */ 26890);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
*/
...
function n(t) {
  ...
  const {
    ...
    h = "multi-directional" === n ? 2 * t.zFactor : t.zFactor,
    {
      x: u,
      y: f
    } = c;
  let d = h / (8 * u),
    p = h / (8 * f);
  if (r && h > .001 && (d /= s, p /= s), "adjusted" === o) if (r) {
    const t = u * s,
      e = f * s;
    d = (h + t ** a * l) / (8 * t), p = (h + e ** a * l) / (8 * e);
  } else d = (h + u ** a * l) / (8 * u), p = (h + f ** a * l) / (8 * f);
  ...
  const A = [315, 270, 225, 360, 180, 0],
    ...
    z = k.reduce((t, e) => t + e),
    F = k.map(t => t / z),
    P = "multi-directional" === n ? A.length : 1,
    C = new Float32Array(6),
    Z = new Float32Array(6),
    v = new Float32Array(6);
  if ("multi-directional" === n) for (let s = 0; s < P; s++) e = g[s], i = A[s], x = (90 - e) * Math.PI / 180, w = Math.cos(x), y = (360 - i + 90) * Math.PI / 180, M = Math.sin(x) * Math.cos(y), m = Math.sin(x) * Math.sin(y), C[s] = w, Z[s] = M, v[s] = m;else C.fill(w), Z.fill(M), v.fill(m);
  return {
    resolution: c,
    factor: [d, p],
    sinZcosA: M,
    ...
    cosZs: C,
    weights: F,
    hillshadeType: ["traditional", "multi-directional"].indexOf(n)
  };
}
function a(t, e) {
  const {
  ...
  if (o) {
    ...
    for (let t = 0; t < r.length; t++) r[t] && (l[t] = 1, r[t] = 1);
  }
  const c = t.pixels[0],
  ...
  if (e) {
    const {
      ...
      i = t ? (t.x + t.y) / 2 : 1;
    d = 200 * e.zFactor / (i * i), f = new Float32Array(a);
  }
  ...
  for (let z = i; z < n - i; z++) {
    ...
    for (let e = i; e < s - i; e++) {
      ...
      if (!r || 0 !== r[i]) {
        if (r) {
          if (r[i - s - 1] + r[i - s] + r[i - s + 1] + r[i - 1] + r[i + 1] + r[i + s - 1] + r[i + s] + r[i + s + 1] < 7) {
            l[i] = 0;
            continue;
          }
          x = r[i - s - 1] ? c[i - s - 1] : c[i], w = r[i - s] ? c[i - s] : c[i], y = r[i - s + 1] ? c[i - s + 1] : c[i], M = r[i - 1] ? c[i - 1] : c[i], m = r[i + 1] ? c[i + 1] : c[i], A = r[i + s - 1] ? c[i + s - 1] : c[i], g = r[i + s] ? c[i + s] : c[i], k = r[i + s + 1] ? c[i + s + 1] : c[i];
        } else x = c[i - s - 1], w = c[i - s], y = c[i - s + 1], M = c[i - 1], m = c[i + 1], A = c[i + s - 1], g = c[i + s], k = c[i + s + 1];
        if (h[i] = y + m + m + k - (x + M + M + A), u[i] = A + g + g + k - (x + w + w + y), null != f) {
          const t = c[i],
            e = .5 * (M + m) - t,
            s = .5 * (w + g) - t;
          if ("standard" === p) f[i] = -d * (e + s);else {
            const t = (-x + y + A - k) / 4,
              n = (-M + m) / 2,
              a = (w - g) / 2,
              l = n * n,
              o = a * a,
              r = l + o;
            r && (f[i] = "profile" === p ? d * (e * l + s * o + t * n * a) / r : -d * (e * o + s * l - t * n * a) / r);
          }
        }
      }
    }
...
function o(s, o) {
  if (!(0,_pixelUtils_js__WEBPACK_IMPORTED_MODULE_1__.isValidPixelBlock)(s)) return s;
  const {
      factor: r,
      sinZcosA: c,
      sinZsinA: h,
    ...
    [w, y] = r,
    M = "traditional" === o.hillshadeType,
    {
      width: m,
      height: A
    } = s,
    g = new Uint8Array(m * A),
    {
      dzxs: k,
      dzys: z,
      outMask: F
  ...
  for (let t = i; t < A - i; t++) {
    ...
    for (let t = i; t < m - i; t++) {
      ...
      if (!F || F[i]) {
        ...
        let n = 0;
        if (M) {
          let i = 255 * (u + h * e - c * t) / s;
          i < 0 && (i = 0), n = i;
        } else {
          const i = d.length;
          for (let a = 0; a < i; a++) {
            let i = 255 * (p[a] + d[a] * e - f[a] * t) / s;
            i < 0 && (i = 0), n += i * x[a];
          }
        }
        g[i] = 255 & n;
...
function r(t, i, s, n) {
  if (!(0,_pixelUtils_js__WEBPACK_IMPORTED_MODULE_1__.isValidPixelBlock)(t) || !(0,_pixelUtils_js__WEBPACK_IMPORTED_MODULE_1__.isValidPixelBlock)(i)) return;
  const {
      min: a,
      max: l
    } = n,
  ...
  for (let e = 0; e < h.length; e++) {
    if (c && 0 === c[e]) continue;
    const t = Math.floor((h[e] - a) * u),
      [i, n] = s[t < 0 ? 0 : t > x ? x : t],
      l = o[e],
      r = l * n,
      w = r * (1 - Math.abs(i % 2 - 1)),
      y = l - r;
    switch (Math.floor(i)) {
      case 0:
        f[e] = r + y, d[e] = w + y, p[e] = y;
        break;
      case 1:
        f[e] = w + y, d[e] = r + y, p[e] = y;
        break;
      case 2:
        f[e] = y, d[e] = r + y, p[e] = w + y;
        break;
      case 3:
        f[e] = y, d[e] = w + y, p[e] = r + y;
        break;
      case 4:
        f[e] = w + y, d[e] = y, p[e] = r + y;
        break;
      case 5:
      case 6:
        f[e] = r + y, d[e] = y, p[e] = w + y;
    }
  }
  t.pixels = [f, d, p], t.updateStatistics();
}
function c(n, o) {
  if (!(0,_pixelUtils_js__WEBPACK_IMPORTED_MODULE_1__.isValidPixelBlock)(n)) return n;
  const r = o.zFactor,
  ...
  let x = r / (8 * d),
    w = r / (8 * p);
  f && Math.abs(r - 1) < 1e-4 && (x /= s, w /= s), "adjusted" === u && (x = (r + d ** c * h) / (8 * d), w = (r + p ** c * h) / (8 * p));
  const {
      dzxs: y,
      dzys: M,
      outMask: m
    ...
    for (let t = i; t < A - i; t++) {
      ...
      if (!m || m[i]) {
        const s = y[i] * x,
          n = M[i] * w,
          a = Math.sqrt(s * s + n * n);
        k[e + t] = "percent-rise" === u ? 100 * a : 57.2957795 * Math.atan(a);
      }
    }
  }
  l(k, A, g);
  const z = new _PixelBlock_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    width: A,
    height: g,
    pixels: [k],
    mask: m,
    ...
    for (let t = i; t < d - i; t++) {
      ...
      if (!f || f[i]) {
        const s = h[i] * r,
          n = u[i] * c;
        let a = -1;
        0 === s && 0 === n || (a = 90 - 57.29578 * Math.atan2(n, -s), a < 0 && (a += 360), 360 === a ? a = 0 : a > 360 && (a %= 360)), x[e + t] = a;
      }
    }
  }
  l(x, d, p);
...
function u(i, s) {
  if (!(0,_pixelUtils_js__WEBPACK_IMPORTED_MODULE_1__.isValidPixelBlock)(i)) return i;
  const {
      curvatures: n,
      outMask: o
    } = a(i, s),
  ...
  l(n, r, c);
  const h = new _PixelBlock_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    width: r,
    height: c,
    pixels: [n],
    mask: o,
...
/* harmony import */ var _layers_support_RasterInfo_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../layers/support/RasterInfo.js */ 14385);
/* harmony import */ var _layers_support_rasterFunctions_pixelUtils_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../layers/support/rasterFunctions/pixelUtils.js */ 26890);
/* harmony import */ var _layers_support_rasterFunctions_stretchUtils_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../layers/support/rasterFunctions/stretchUtils.js */ 34589);
/* harmony import */ var _layers_support_rasterFunctions_surfaceUtils_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../layers/support/rasterFunctions/surfaceUtils.js */ 26908);
/* harmony import */ var _colorRampUtils_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./colorRampUtils.js */ 49084);
/* harmony import */ var _rasterRendererChecks_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./rasterRendererChecks.js */ 17186);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
*/
...
let C = class extends _core_JSONSupport_js__WEBPACK_IMPORTED_MODULE_2__.JSONSupport {
  constructor(e) {
    super(e);
  }
  bind() {
  ...
  symbolize(e) {
    ...
    try {
      ...
      return _core_Logger_js__WEBPACK_IMPORTED_MODULE_3__["default"].getLogger(this).error("symbolize", r.message), t;
    }
  }
  simpleStretch(e, t) {
    if (!_(e)) return e;
    try {
      return e.pixels.length > 3 && (e = e.extractBands([0, 1, 2])), (0,_layers_support_rasterFunctions_stretchUtils_js__WEBPACK_IMPORTED_MODULE_11__.stretch)(e, {
        ...t,
        isRenderer: !0
      });
    } catch (r) {
      return _core_Logger_js__WEBPACK_IMPORTED_MODULE_3__["default"].getLogger(this).error("symbolize", r.message), e;
    }
  }
  ...
  _symbolizeColormap(e) {
    ...
    return (0,_layers_support_rasterFunctions_pixelUtils_js__WEBPACK_IMPORTED_MODULE_10__.colorize)(e, this.lookup.colormapLut);
  }
  _symbolizeClassBreaks(e) {
    ...
    return t ? (0,_layers_support_rasterFunctions_pixelUtils_js__WEBPACK_IMPORTED_MODULE_10__.colorize)(e, this.lookup.colormapLut) : (0,_layers_support_rasterFunctions_pixelUtils_js__WEBPACK_IMPORTED_MODULE_10__.remapColor)(e, this.lookup.remapLut ?? []);
  }
  _symbolizeStretch(e, t) {
    ...
    if ("histogramEqualization" === a.stretchType) {
      const s = p ? null : this.lookup?.histogramLut,
        o = (0,_layers_support_rasterFunctions_stretchUtils_js__WEBPACK_IMPORTED_MODULE_11__.getStretchCutoff)(a, {
          rasterInfo: r,
          pixelBlock: e,
          bandIds: t,
          returnHistogramLut: !s
        }),
        n = (0,_layers_support_rasterFunctions_stretchUtils_js__WEBPACK_IMPORTED_MODULE_11__.stretch)(e, {
          ...o,
          gamma: f,
          isRenderer: !0
        });
      c = (0,_layers_support_rasterFunctions_pixelUtils_js__WEBPACK_IMPORTED_MODULE_10__.lookupPixels)(n, {
        lut: p ? o.histogramLut : s,
        offset: 0
      });
    } else if (n) {
      if (p) {
        const o = (0,_layers_support_rasterFunctions_stretchUtils_js__WEBPACK_IMPORTED_MODULE_11__.getStretchCutoff)(a, {
          rasterInfo: r,
          pixelBlock: e,
          bandIds: t
        });
        l = (0,_layers_support_rasterFunctions_stretchUtils_js__WEBPACK_IMPORTED_MODULE_11__.createStretchLUT)({
          pixelType: s,
          ...o,
          gamma: f,
          rounding: "floor"
      ...
      o > 1 && null != t && t.length === e?.pixels.length && l?.lut.length === o && (l = {
        lut: t.map(e => l.lut[e]),
        offset: l.offset
      }), c = (0,_layers_support_rasterFunctions_pixelUtils_js__WEBPACK_IMPORTED_MODULE_10__.lookupPixels)(e, l);
    } else {
      const s = (0,_layers_support_rasterFunctions_stretchUtils_js__WEBPACK_IMPORTED_MODULE_11__.getStretchCutoff)(a, {
        rasterInfo: r,
        pixelBlock: e,
        bandIds: t
      });
      c = (0,_layers_support_rasterFunctions_stretchUtils_js__WEBPACK_IMPORTED_MODULE_11__.stretch)(e, {
        ...s,
        gamma: f,
        isRenderer: !0
      });
    ...
    if (a.colorRamp) {
      ...
      c = (0,_layers_support_rasterFunctions_pixelUtils_js__WEBPACK_IMPORTED_MODULE_10__.colorize)(c, this.lookup?.colormapLut);
    }
    return c;
  }
  _symbolizeShadedRelief(e, t) {
    const r = this.rendererJSON,
      ...
      o = (0,_layers_support_rasterFunctions_surfaceUtils_js__WEBPACK_IMPORTED_MODULE_12__.hillshade)(e, s);
    ...
    return (0,_layers_support_rasterFunctions_surfaceUtils_js__WEBPACK_IMPORTED_MODULE_12__.tintHillshade)(o, e, a, n), o;
  }
  _isVectorFieldData() {
    const {
      bandCount: e,
  ...
  _updateUVRenderer(e) {
    ...
    if (!(0,_rasterRendererChecks_js__WEBPACK_IMPORTED_MODULE_14__.isUVRendererSupported)(this.rasterInfo, o) && !n) return {
      success: !1,
    ...
    const l = (0,_layers_support_rasterFunctions_pixelUtils_js__WEBPACK_IMPORTED_MODULE_10__.createColormapLUT)({
      colormap: i
    });
    return this.lookup = {
      rendererJSON: e,
      colormapLut: l
    }, this.canRenderInWebGL = this._isColormapSupportedByWebGL(l?.indexedColormap), {
      success: !0
    };
  }
  _updateColormapRenderer(e) {
    if (!(0,_rasterRendererChecks_js__WEBPACK_IMPORTED_MODULE_14__.isColormapRendererSupported)(this.rasterInfo)) return {
      success: !1,
    ...
    const r = (0,_layers_support_rasterFunctions_pixelUtils_js__WEBPACK_IMPORTED_MODULE_10__.createColormapLUT)({
      colormap: t
    });
    return this.lookup = {
      rendererJSON: e,
      colormapLut: r
    }, this.canRenderInWebGL = this._isColormapSupportedByWebGL(r?.indexedColormap), {
      success: !0
    };
  }
  _updateShadedReliefRenderer(e) {
    if (!(0,_rasterRendererChecks_js__WEBPACK_IMPORTED_MODULE_14__.isShadedReliefRendererSupported)(this.rasterInfo)) return {
      success: !1,
    ...
    if (e.colorRamp) {
      const r = (0,_colorRampUtils_js__WEBPACK_IMPORTED_MODULE_13__.convertColorRampToColormap)(e.colorRamp, {
          interpolateAlpha: !0
        }),
        s = (0,_layers_support_rasterFunctions_pixelUtils_js__WEBPACK_IMPORTED_MODULE_10__.createColormapLUT)({
          colormap: r
        }),
        o = [],
        a = s.indexedColormap;
      for (let e = 0; e < a.length; e += 4) {
        const r = (0,_core_colorUtils_js__WEBPACK_IMPORTED_MODULE_1__.toHSV)({
          r: a[e],
          g: a[e + 1],
          b: a[e + 2]
        });
  ...
  _updateClassBreaksRenderer(e) {
    ...
    const p = (0,_layers_support_rasterFunctions_pixelUtils_js__WEBPACK_IMPORTED_MODULE_10__.createColormapLUT)({
      colormap: u,
      fillUnspecified: !1
    });
    return this.lookup = {
      rendererJSON: e,
      colormapLut: p
    }, this.canRenderInWebGL = this._isColormapSupportedByWebGL(p?.indexedColormap), {
      success: !0
    };
  }
  ...
  _updateStretchRenderer(e) {
    ...
    if (a && o && !i?.length) {
      ...
      i = (0,_layers_support_rasterFunctions_stretchUtils_js__WEBPACK_IMPORTED_MODULE_11__.computeGammaValues)(this.rasterInfo.pixelType, t);
    }
    const l = this.rasterInfo.pixelType,
      u = !r && ["u8", "u16", "s8", "s16"].includes(l);
    if ("histogramEqualization" === t) {
      const t = s.map(e => (0,_layers_support_rasterFunctions_stretchUtils_js__WEBPACK_IMPORTED_MODULE_11__.createHistogramEqualizationLUT)(e));
      this.lookup = {
        rendererJSON: e,
        histogramLut: t
      };
    } else if (u) {
      const t = (0,_layers_support_rasterFunctions_stretchUtils_js__WEBPACK_IMPORTED_MODULE_11__.getStretchCutoff)(e, {
          rasterInfo: this.rasterInfo
        }),
        r = (0,_layers_support_rasterFunctions_stretchUtils_js__WEBPACK_IMPORTED_MODULE_11__.createStretchLUT)({
          pixelType: l,
          ...t,
          gamma: a ? i : null,
          rounding: "floor"
    ...
    if (n && !this._isStretchColorRampNoop(n)) {
      const t = (0,_colorRampUtils_js__WEBPACK_IMPORTED_MODULE_13__.convertColorRampToColormap)(n, {
        interpolateAlpha: !0
      });
      this.lookup || (this.lookup = {
        rendererJSON: e
      }), this.lookup.colormapLut = (0,_layers_support_rasterFunctions_pixelUtils_js__WEBPACK_IMPORTED_MODULE_10__.createColormapLUT)({
        colormap: t
  ...
  _generateStretchWebGLParams(e, t, r) {
    ...
    const {
      ...
      i = !!(t.useGamma && n && n.some(e => 1 !== e)),
      {
        minCutOff: l,
        maxCutOff: u,
        outMin: c,
        outMax: p
      } = (0,_layers_support_rasterFunctions_stretchUtils_js__WEBPACK_IMPORTED_MODULE_11__.getStretchCutoff)(t, {
        rasterInfo: this.rasterInfo,
        pixelBlock: e,
        bandIds: r
      });
    ...
    const {
      ...
      b = s || i ? 1 : 255;
    let g;
    for (g = 0; g < l.length; g++) y[g] = u[g] === l[g] ? 0 : (p - c) / (u[g] - l[g]) / b;
    const S = new Float32Array(f);
    if (i && n) for (g = 0; g < f; g++) n[g] > 1 ? n[g] > 2 ? S[g] = 6.5 + (n[g] - 2) ** 2.5 : S[g] = 6.5 + 100 * (2 - n[g]) ** 4 : S[g] = 1;
    return {
      bandCount: f,
      outMin: c / b,
      outMax: p / b,
  ...
  _generateShadedReliefWebGLParams(e, t = !1, r = {
    ...
    const n = {
      ...
      i = (0,_layers_support_rasterFunctions_surfaceUtils_js__WEBPACK_IMPORTED_MODULE_12__.calculateHillshadeParams)(n),
...
function _(e) {
  return (0,_layers_support_rasterFunctions_pixelUtils_js__WEBPACK_IMPORTED_MODULE_10__.isValidPixelBlock)(e) && 0 !== e.validPixelCount;
}
...
})], C.prototype, "rendererJSON", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_4__.property)({
  type: _layers_support_RasterInfo_js__WEBPACK_IMPORTED_MODULE_9__["default"],
  json: {
    write: !0
  }
})], C.prototype, "rasterInfo", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_4__.property)({
  json: {
    write: !0
  }
})], C.prototype, "lookup", void 0), (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_4__.property)()], C.prototype, "canRenderInWebGL", void 0), C = (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_subclass_js__WEBPACK_IMPORTED_MODULE_8__.subclass)("esri.renderers.support.RasterSymbolizer")], C);
const L = C;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "colorRampDict": () => (/* binding */ a),
/* harmony export */   "convertColorRampToColormap": () => (/* binding */ B),
/* harmony export */   "convertColorRampToColors": () => (/* binding */ w),
/* harmony export */   "convertRGBATo32Bit": () => (/* binding */ A),
/* harmony export */   "getColorRampId": () => (/* binding */ s),
/* harmony export */   "getColorRampJSON": () => (/* binding */ d),
/* harmony export */   "getColorRampName": () => (/* binding */ c),
/* harmony export */   "getRFxArgColorRampValue": () => (/* binding */ G),
/* harmony export */   "predefinedJsonColorRamps": () => (/* binding */ m),
/* harmony export */   "rasterColormapNames": () => (/* binding */ C)
/* harmony export */ });
/* harmony import */ var _Color_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../Color.js */ 25764);
/* harmony import */ var _core_colorUtils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../core/colorUtils.js */ 44660);
/* harmony import */ var _core_jsonMap_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../core/jsonMap.js */ 63321);
/* harmony import */ var _core_JSONSupport_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../core/JSONSupport.js */ 69237);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
*/
...
const C = ["random", "ndvi", "ndvi2", "ndvi3", "elevation", "gray", "hillshade"],
  ...
  a = new _core_jsonMap_js__WEBPACK_IMPORTED_MODULE_2__.JSONMap({
    Aspect: "aspect",
...
function f(r, t) {
  ...
  return "algorithmic" === r.type ? l.some(o => {
    ...
    if (l && i && l.length === i.length && !i.some((r, t) => {
      if (!g(l[t].fromColor.toRgb(), new _Color_js__WEBPACK_IMPORTED_MODULE_0__["default"](r.fromColor).toRgb()) || !g(l[t].toColor.toRgb(), new _Color_js__WEBPACK_IMPORTED_MODULE_0__["default"](r.toColor).toRgb())) return !0;
    })) {
      if (e) return !0;
      e = t.id;
    }
...
function s(o, r, t = !1) {
  if (!o) return;
  let l = f(o, r);
  return null != l || t || (l = f(o = u(o), r)), l;
}
function c(o, r = !1) {
  const t = "string" == typeof o ? o : s(o, void 0, r);
...
function y(o, i) {
  ...
  const s = {
    ...
    d = "esriCIELabAlgorithm" === m ? v((0,_core_colorUtils_js__WEBPACK_IMPORTED_MODULE_1__.toLAB)(s), (0,_core_colorUtils_js__WEBPACK_IMPORTED_MODULE_1__.toLAB)(c), a) : "esriHSVAlgorithm" === m ? b((0,_core_colorUtils_js__WEBPACK_IMPORTED_MODULE_1__.toHSV)(s), (0,_core_colorUtils_js__WEBPACK_IMPORTED_MODULE_1__.toHSV)(c), a) : k((0,_core_colorUtils_js__WEBPACK_IMPORTED_MODULE_1__.toLCH)(s), (0,_core_colorUtils_js__WEBPACK_IMPORTED_MODULE_1__.toLCH)(c), a),
    y = [],
    R = n[3] ?? 255,
    w = ((C[3] ?? 255) - R) / (g - 1);
  for (let r = 0; r < g; r++) {
    const {
        ...
        g: t,
        b: l
      } = (0,_core_colorUtils_js__WEBPACK_IMPORTED_MODULE_1__.toRGB)(d[r]),
...
function R(o, r) {
  ...
  for (let u = 0; u < i.length; u++) {
    ...
    const p = y(i[u], {
      ...
      interpolateAlpha: l,
      distanceOffset: o,
      distanceInterval: a / e[u]
    });
    C += p.length, n.push(...p), m += e[u];
  }
  const p = [...i[i.length - 1].toColor];
  return 3 === p.length && p.push(255), n.push(p), n;
}
function w(o, r) {
  const t = (0,_core_JSONSupport_js__WEBPACK_IMPORTED_MODULE_3__.isSerializable)(o) ? o.toJSON() : o;
...
function D(o) {
  const r = (0,_core_colorUtils_js__WEBPACK_IMPORTED_MODULE_1__.toHSV)(o);
  return {
    type: "HsvColor",
    Hue: r.h,
    Saturation: r.s,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "isClassBreaksSupported": () => (/* binding */ r),
/* harmony export */   "isColormapRendererSupported": () => (/* binding */ u),
/* harmony export */   "isFlowRendererSupported": () => (/* binding */ i),
/* harmony export */   "isShadedReliefRendererSupported": () => (/* binding */ e),
/* harmony export */   "isSingleBand8BitRasterWithStats": () => (/* binding */ n),
/* harmony export */   "isUVRendererSupported": () => (/* binding */ t),
/* harmony export */   "isVectorFieldRendererSupported": () => (/* binding */ o)
/* harmony export */ });
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
...
const n = new _core_jsonMap_js__WEBPACK_IMPORTED_MODULE_0__.JSONMap({
    none: "none",
...
//# sourceMappingURL=default-node_modules_arcgis_core_layers_support_rasterFormats_RasterCodec_js-node_modules_arc-fe02d7.js.map