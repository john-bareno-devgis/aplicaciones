"use strict";
(self["webpackChunkrealgis"] = self["webpackChunkrealgis"] || []).push([["node_modules_esri_calcite-components_dist_components_index3_js"],{
...
const supportedTimeZones = (() => {
  ...
  const etcTimeZones = ["Etc/GMT+1", "Etc/GMT+10", "Etc/GMT+11", "Etc/GMT+12", "Etc/GMT+2", "Etc/GMT+3", "Etc/GMT+4", "Etc/GMT+5", "Etc/GMT+6", "Etc/GMT+7", "Etc/GMT+8", "Etc/GMT+9", "Etc/GMT-1", "Etc/GMT-10", "Etc/GMT-11", "Etc/GMT-12", "Etc/GMT-13", "Etc/GMT-14", "Etc/GMT-2", "Etc/GMT-3", "Etc/GMT-4", "Etc/GMT-5", "Etc/GMT-6", "Etc/GMT-7", "Etc/GMT-8", "Etc/GMT-9"];
...
const continentAllowList = new Set(['Europe', 'Asia', 'America', 'America/Argentina', 'Africa', 'Australia', 'Pacific', 'Atlantic', 'Antarctica', 'Arctic', 'Indian']);
...
function groupTimeZones(_x) {
  return _groupTimeZones.apply(this, arguments);
}
function _groupTimeZones() {
  _groupTimeZones = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (options) {
    const {
      debug,
      groupDateRange,
      hooks,
    ...
    const timeZoneItems = supportedTimeZones.map(tz => ({
      label: tz
    }));
    ...
    return hooks?.onFinalGroupingCreate ? hooks.onFinalGroupingCreate(finalGrouping) : finalGrouping;
  });
  return _groupTimeZones.apply(this, arguments);
}
...
//# sourceMappingURL=node_modules_esri_calcite-components_dist_components_index3_js.js.map