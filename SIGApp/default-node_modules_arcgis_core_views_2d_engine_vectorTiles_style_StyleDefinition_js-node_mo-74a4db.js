"use strict";
(self["webpackChunkrealgis"] = self["webpackChunkrealgis"] || []).push([["default-node_modules_arcgis_core_views_2d_engine_vectorTiles_style_StyleDefinition_js-node_mo-74a4db"],{
...
var a, i, n, l, u, m, o, r, p;
!function (e) {
  e[e.BACKGROUND = 0] = "BACKGROUND", e[e.FILL = 1] = "FILL", e[e.LINE = 2] = "LINE", e[e.SYMBOL = 3] = "SYMBOL", e[e.CIRCLE = 4] = "CIRCLE";
}(a || (a = {})), function (e) {
  e[e.VISIBLE = 0] = "VISIBLE", e[e.NONE = 1] = "NONE";
}(i || (i = {})), function (e) {
  e[e.POINT = 0] = "POINT", e[e.LINE = 1] = "LINE", e[e.LINE_CENTER = 2] = "LINE_CENTER";
}(n || (n = {})), function (e) {
  e[e.MAP = 0] = "MAP", e[e.VIEWPORT = 1] = "VIEWPORT", e[e.AUTO = 2] = "AUTO";
}(l || (l = {})), function (e) {
  e[e.AUTO = 0] = "AUTO", e[e.LEFT = 1] = "LEFT", e[e.CENTER = 2] = "CENTER", e[e.RIGHT = 3] = "RIGHT";
}(u || (u = {})), function (e) {
  e[e.CENTER = 0] = "CENTER", e[e.LEFT = 1] = "LEFT", e[e.RIGHT = 2] = "RIGHT", e[e.TOP = 3] = "TOP", e[e.BOTTOM = 4] = "BOTTOM", e[e.TOP_LEFT = 5] = "TOP_LEFT", e[e.TOP_RIGHT = 6] = "TOP_RIGHT", e[e.BOTTOM_LEFT = 7] = "BOTTOM_LEFT", e[e.BOTTOM_RIGHT = 8] = "BOTTOM_RIGHT";
}(m || (m = {})), function (e) {
  e[e.NONE = 0] = "NONE", e[e.UPPERCASE = 1] = "UPPERCASE", e[e.LOWERCASE = 2] = "LOWERCASE";
}(o || (o = {})), function (e) {
  e[e.MAP = 0] = "MAP", e[e.VIEWPORT = 1] = "VIEWPORT";
}(r || (r = {})), function (e) {
...
f.backgroundLayoutDefinition = {
  ...
  "line-cap": {
    ...
    default: _symbols_cim_enums_js__WEBPACK_IMPORTED_MODULE_0__.CapType.BUTT
  },
  "line-join": {
    type: "enum",
    values: ["bevel", "round", "miter"],
    default: _symbols_cim_enums_js__WEBPACK_IMPORTED_MODULE_0__.JoinType.MITER
  },
  "line-miter-limit": {
    type: "number",
    default: 2
...
//# sourceMappingURL=default-node_modules_arcgis_core_views_2d_engine_vectorTiles_style_StyleDefinition_js-node_mo-74a4db.js.map