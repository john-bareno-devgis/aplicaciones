"use strict";
(self["webpackChunkrealgis"] = self["webpackChunkrealgis"] || []).push([["default-node_modules_esri_calcite-components_dist_components_t9n_js"],{
...
const locales = ["ar", "bg", "bs", "ca", "cs", "da", "de", "de-AT", "de-CH", "el", defaultLocale, "en-AU", "en-CA", "en-GB", "es", "es-MX", "et", "fi", "fr", "fr-CH", "he", "hi", "hr", "hu", "id", "it", "it-CH", "ja", "ko", "lt", "lv", "mk", "no", "nl", "pl", "pt", "pt-PT", "ro", "ru", "sk", "sl", "sr", "sv", "th", "tr", "uk", "vi", "zh-CN", "zh-HK", "zh-TW"];
...
function getLocale(component) {
  return component.el.lang || (0,_dom_js__WEBPACK_IMPORTED_MODULE_0__.c)(component.el, "[lang]")?.lang || document.documentElement.lang || defaultLocale;
}
/**
...
function _getMessageBundle() {
  _getMessageBundle = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (lang, component) {
    const key = `${component}_${lang}`;
    if (componentLangToMessageBundleCache[key]) {
      return componentLangToMessageBundleCache[key];
    }
    componentLangToMessageBundleCache[key] = fetch((0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_2__.getAssetPath)(`./assets/${component}/t9n/messages_${lang}.json`)).then(resp => {
      if (!resp.ok) {
...
function _setUpMessages() {
  _setUpMessages = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (component) {
...
function _fetchMessages() {
  _fetchMessages = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (component, lang) {
    ...
    return getMessageBundle((0,_locale_js__WEBPACK_IMPORTED_MODULE_1__.g)(lang, "t9n"), componentName);
  });
  return _fetchMessages.apply(this, arguments);
}
...
function _updateMessages() {
  _updateMessages = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (component, lang) {
...
//# sourceMappingURL=default-node_modules_esri_calcite-components_dist_components_t9n_js.js.map