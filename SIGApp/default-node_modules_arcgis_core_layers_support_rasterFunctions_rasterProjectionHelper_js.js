"use strict";
(self["webpackChunkrealgis"] = self["webpackChunkrealgis"] || []).push([["default-node_modules_arcgis_core_layers_support_rasterFunctions_rasterProjectionHelper_js"],{
...
/* harmony export */   "computeProjectedScales": () => (/* binding */ ae),
/* harmony export */   "defaultGridSpacing": () => (/* binding */ P),
...
/* harmony export */   "getProjectedGridPoints": () => (/* binding */ L),
/* harmony export */   "getProjectionOffsetGrid": () => (/* binding */ ee),
/* harmony export */   "getRasterDatasetAlignmentInfo": () => (/* binding */ Z),
/* harmony export */   "getWorldWidth": () => (/* binding */ D),
/* harmony export */   "getWorldWrapCount": () => (/* binding */ V),
/* harmony export */   "load": () => (/* binding */ T),
/* harmony export */   "minimumGridSpacing": () => (/* binding */ b),
/* harmony export */   "projectDatasetExtent": () => (/* binding */ se),
/* harmony export */   "projectExtent": () => (/* binding */ J),
/* harmony export */   "projectPoint": () => (/* binding */ j),
/* harmony export */   "projectPolygon": () => (/* binding */ U),
/* harmony export */   "projectResolution": () => (/* binding */ C),
/* harmony export */   "requirePE": () => (/* binding */ M),
/* harmony export */   "shiftExtent": () => (/* binding */ oe),
/* harmony export */   "snapExtent": () => (/* binding */ ie),
/* harmony export */   "snapPyramid": () => (/* binding */ re)
/* harmony export */ });
...
/* harmony import */ var _core_arrayUtils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../core/arrayUtils.js */ 19420);
...
/* harmony import */ var _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../chunks/pe.js */ 48323);
...
/* harmony import */ var _geometry_Polygon_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../geometry/Polygon.js */ 55733);
...
var d;
function M(e, t, n) {
  return !(0,_geometry_projection_js__WEBPACK_IMPORTED_MODULE_6__.canProjectWithoutEngine)(e, t, n);
}
function w(e, n, i) {
  const o = M(e, n, i);
  if (o && !(0,_geometry_projection_js__WEBPACK_IMPORTED_MODULE_6__.isLoaded)()) throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_3__["default"]("rasterprojectionhelper-project", "projection engine is not loaded");
  return o;
}
!function (e) {
...
function _T() {
  _T = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    (0,_geometry_projection_js__WEBPACK_IMPORTED_MODULE_6__.isLoaded)() || (yield (0,_geometry_projection_js__WEBPACK_IMPORTED_MODULE_6__.load)());
  });
  return _T.apply(this, arguments);
}
function v(e, t, n) {
  w(e.spatialReference, t);
  return n ? (0,_geometry_projection_js__WEBPACK_IMPORTED_MODULE_6__.getTransformation)(t, e.spatialReference, e) : (0,_geometry_projection_js__WEBPACK_IMPORTED_MODULE_6__.getTransformation)(e.spatialReference, t, e);
}
function C(e, t, i, o = null) {
  ...
  w(r, t, o);
  const s = i.center,
    a = new _geometry_Extent_js__WEBPACK_IMPORTED_MODULE_8__["default"]({
      xmin: s.x - e.x / 2,
      xmax: s.x + e.x / 2,
      ymin: s.y - e.y / 2,
      ymax: s.y + e.y / 2,
    ...
    l = (0,_geometry_projection_js__WEBPACK_IMPORTED_MODULE_6__.project)(a, t, o),
    c = D(t);
  let f;
  if (null == l || null != c && l.width >= c) {
    const i = (0,_core_unitUtils_js__WEBPACK_IMPORTED_MODULE_4__.getMetersPerUnitForSR)(r) / (0,_core_unitUtils_js__WEBPACK_IMPORTED_MODULE_4__.getMetersPerUnitForSR)(t);
    f = {
      x: e.x * i,
      y: e.y * i
    };
...
function _(e, t = .01) {
  return (0,_core_unitUtils_js__WEBPACK_IMPORTED_MODULE_4__.getMetersPerUnitForSR)(e) ? t / (0,_core_unitUtils_js__WEBPACK_IMPORTED_MODULE_4__.getMetersPerUnitForSR)(e) : 0;
}
function j(e, t, n = null, i = !0) {
  const o = e.spatialReference;
  if (o.equals(t)) return e;
  w(o, t, n);
  const r = (0,_geometry_projection_js__WEBPACK_IMPORTED_MODULE_6__.project)(e, t, n);
...
function I(e) {
  const {
    ...
    r = t.map(e => new _geometry_Point_js__WEBPACK_IMPORTED_MODULE_9__["default"](e[0], e[1], n)),
    s = (0,_geometry_projection_js__WEBPACK_IMPORTED_MODULE_6__.project)(r, i, o);
...
function W(e) {
  ...
  if (!t.isGeographic) {
    const e = t.wkid ? _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.P.coordsys(t.wkid) : _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.P.fromString(t.isGeographic ? _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.a.PE_TYPE_GEOGCS : _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.a.PE_TYPE_PROJCS, t.wkt2 || t.wkt);
    _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.g.projToGeog(e, c.length, c);
  }
  if (null != a && a.steps.length) {
    let e;
    const t = 179.9955;
    if (n.isGeographic && (e = c.map(([e]) => e > t ? 1 : e < -t ? -1 : 0)), a.steps.forEach(e => {
      const t = e.wkid ? _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.P.geogtran(e.wkid) : _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.P.fromString(_chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.a.PE_TYPE_GEOGTRAN, e.wkt);
      _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.h.geogToGeog(t, c.length, c, null, e.isInverse ? _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.a.PE_TRANSFORM_2_TO_1 : _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.a.PE_TRANSFORM_1_TO_2);
  ...
  if (!n.isGeographic) {
    ...
    Y(c, t);
    const s = n.wkid ? _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.P.coordsys(n.wkid) : _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.P.fromString(n.isGeographic ? _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.a.PE_TYPE_GEOGCS : _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.a.PE_TYPE_PROJCS, n.wkt2 || n.wkt);
    _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.g.geogToProj(s, c.length, c);
  }
  let u = c;
...
function O(e) {
  ...
  for (let g = 0; g < x; g++) {
    const e = l + i * Math.min(t, g),
      r = c - o * Math.min(n, g),
      x = (0,_geometry_projection_js__WEBPACK_IMPORTED_MODULE_6__.project)(new _geometry_Point_js__WEBPACK_IMPORTED_MODULE_9__["default"]({
        x: e,
        y: r,
        spatialReference: s
      }), a);
...
function A(e, t = !1) {
  ...
  const r = e.wkid ? _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.P.coordsys(e.wkid) : _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.P.fromString(e.isGeographic ? _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.a.PE_TYPE_GEOGCS : _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.a.PE_TYPE_PROJCS, e.wkt2 || e.wkt),
    s = B(r, _(e, 1e-4)),
    a = B(r, 0, !0);
  return k.set(n, {
    pcs: s,
...
function B(e, t = 0, n = !1) {
  const i = _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.j.generate(e),
...
function q(e, t) {
  ...
  return new _geometry_Extent_js__WEBPACK_IMPORTED_MODULE_8__["default"]({
    xmin: i,
    xmax: o,
    ymin: r,
    ymax: s,
...
function J(t, n, i = null, o = !0) {
  ...
  if (0 === s || null == a || null == l) {
    const e = K(t, n, i, o);
    if (null == a && null != l && Math.abs(e.width - l) < _(n) && (0,_geometry_projection_js__WEBPACK_IMPORTED_MODULE_6__.isLoaded)()) {
      const i = A(r);
  ...
  if (1 === f.length && t.xmax < a && t.xmax - a / 2 > _(r)) {
    ...
    for (let i = 0; i <= s; i++) {
      const o = 0 === i ? e : -a / 2,
        l = i === s ? n - a * i : a / 2;
      f[i] = new _geometry_Extent_js__WEBPACK_IMPORTED_MODULE_8__["default"]({
        xmin: o,
        xmax: l,
        ymin: t.ymin,
        ymax: t.ymax,
  ...
  return q(f.map(e => K(e, n, i, o)).filter(_core_arrayUtils_js__WEBPACK_IMPORTED_MODULE_2__.isSome));
}
function U(e, t, n) {
  if ("extent" === e.type) {
    const {
    ...
    e = new _geometry_Polygon_js__WEBPACK_IMPORTED_MODULE_10__["default"]({
      rings: [[[t, o], [i, o], [i, n], [t, n], [t, o]]],
      spatialReference: r
    });
  }
  return e.spatialReference.equals(t) ? e : (w(e.spatialReference, t, n), (0,_geometry_projection_js__WEBPACK_IMPORTED_MODULE_6__.project)(e, t, n));
}
function X(e, t) {
  const n = D(t);
  ...
  const a = e.spatialReference,
    l = new _geometry_Polygon_js__WEBPACK_IMPORTED_MODULE_10__["default"]({
      spatialReference: a,
      rings: [[[i, o], [r, o], [r, s], [i, s], [i, o]]]
    }),
    c = (0,_geometry_projection_js__WEBPACK_IMPORTED_MODULE_6__.project)(l, t);
  if (2 !== c.rings.length || !c.rings[0].length || !c.rings[1].length) return null;
  const {
      rings: f
    } = c,
    u = _(a),
    x = new _geometry_Extent_js__WEBPACK_IMPORTED_MODULE_8__["default"]({
      spatialReference: t
    });
  for (let m = 0; m < 2; m++) {
...
function K(e, t, n = null, i = !0, o = !0) {
  ...
  w(r, t, n);
  const s = (0,_geometry_projection_js__WEBPACK_IMPORTED_MODULE_6__.project)(e, t, n);
  ...
  if (Math.abs(s.xmin - l[0]) < u && Math.abs(s.xmax - l[1]) < u) {
    ...
    if (i < c && o > f) {
      s.xmin = l[0];
      const i = [];
      i.push(new _geometry_Point_js__WEBPACK_IMPORTED_MODULE_9__["default"](e.xmax, e.ymin, r)), i.push(new _geometry_Point_js__WEBPACK_IMPORTED_MODULE_9__["default"](e.xmax, (e.ymin + e.ymax) / 2, r)), i.push(new _geometry_Point_js__WEBPACK_IMPORTED_MODULE_9__["default"](e.xmax, e.ymax, r));
    ...
    if (o < c && i > f) {
      s.xmax = l[1];
      const i = [];
      i.push(new _geometry_Point_js__WEBPACK_IMPORTED_MODULE_9__["default"](e.xmin, e.ymin, r)), i.push(new _geometry_Point_js__WEBPACK_IMPORTED_MODULE_9__["default"](e.xmin, (e.ymin + e.ymax) / 2, r)), i.push(new _geometry_Point_js__WEBPACK_IMPORTED_MODULE_9__["default"](e.xmin, e.ymax, r));
      const o = i.map(e => j(e, t, n)).filter(e => !isNaN(e?.x)).map(e => e.x);
...
function $(e) {
  ...
  if (N.has(t)) n = N.get(t);else {
    n = (e.wkid ? _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.P.coordsys(e.wkid) : _chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.P.fromString(_chunks_pe_js__WEBPACK_IMPORTED_MODULE_5__.a.PE_TYPE_PROJCS, e.wkt2 || e.wkt)).getGeogcs().getCode(), N.set(t, n);
  }
  return new _geometry_SpatialReference_js__WEBPACK_IMPORTED_MODULE_11__["default"]({
    wkid: n
  });
}
function ee(e) {
  ...
  for (let w = 0; w < R; w++) {
    ...
    for (let t = 0; t < S; t++) {
      ...
      if (h && n[0] > j && n[0] > x / 2 - O ? n[0] -= x : h && 0 === w && n[0] < 0 && B && !r && (n[0] += x), !n || isNaN(n[0]) || isNaN(n[1])) k.push(v), k.push(v), e.push(null), T++;else {
        if (r) {
          const e = r.inverseTransform(new _geometry_Point_js__WEBPACK_IMPORTED_MODULE_9__["default"]({
            x: n[0],
            y: n[1],
            spatialReference: a
          }));
...
function oe(e) {
  const {
    ...
    n = (0,_geometry_support_spatialReferenceUtils_js__WEBPACK_IMPORTED_MODULE_7__.getInfo)(t);
  if (!n) return e;
  const [i, o] = n.valid,
    r = o - i;
  let s = 0;
...
function re(e, t, i) {
  ...
  if (null != l && l.length) {
    ...
    const u = 0 === s ? r : l[s - 1];
    if (a) {
      Math.min(u.x, u.y) * (0,_core_unitUtils_js__WEBPACK_IMPORTED_MODULE_4__.getMetersPerUnitForSR)(t.spatialReference) > 19567 && (a = !1);
    }
    return {
      pyramidLevel: s,
      pyramidResolution: new _geometry_Point_js__WEBPACK_IMPORTED_MODULE_9__["default"]({
        x: u.x,
        y: u.y,
...
function ae(e, t, i) {
  const o = i?.tileSize ?? 512,
    ...
    f = C(new _geometry_Point_js__WEBPACK_IMPORTED_MODULE_9__["default"]({
      x: c.x,
      y: c.y,
      spatialReference: l
    }), t, a);
  ...
  const u = (f.x + f.y) / 2,
    m = (0,_core_unitUtils_js__WEBPACK_IMPORTED_MODULE_4__.getMetersPerUnitForSR)(t),
    x = u * m * 96 * 39.37,
  ...
  if (g) {
    ...
    M = C(new _geometry_Point_js__WEBPACK_IMPORTED_MODULE_9__["default"]({
      x: e,
      y: e,
      spatialReference: {
        wkid: i
...
//# sourceMappingURL=default-node_modules_arcgis_core_layers_support_rasterFunctions_rasterProjectionHelper_js.js.map