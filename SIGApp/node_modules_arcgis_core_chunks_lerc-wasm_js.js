"use strict";
(self["webpackChunkrealgis"] = self["webpackChunkrealgis"] || []).push([["node_modules_arcgis_core_chunks_lerc-wasm_js"],{
...
o.exports, e = o, o.exports, r = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, "undefined" != typeof __filename && (r = r || __filename), i = function (t) {
  ...
  h ? (d = l ? require("path").dirname(d) + "/" : __dirname + "/", c = () => {
    ...
    return c(), t = a.normalize(t), s.readFileSync(t, n ? void 0 : "utf8");
  }, u = t => {
    var n = i(t, !0);
    return n.buffer || (n = new Uint8Array(n)), n;
  }, o = (t, n, e) => {
    c(), t = a.normalize(t), s.readFile(t, function (t, r) {
      t ? e(t) : n(r.buffer);
    });
  ...
  }) : (p || l) && (l ? d = self.location.href : "undefined" != typeof document && document.currentScript && (d = document.currentScript.src), r && (d = r), d = 0 !== d.indexOf("blob:") ? d.substr(0, d.replace(/[?#].*/, "").lastIndexOf("/") + 1) : "", i = t => {
  ...
  function j(t, n, e) {
    ...
    if (i - n > 16 && t.buffer && P) return P.decode(t.subarray(n, i));
    for (var o = ""; n < i;) {
      var u = t[n++];
      if (128 & u) {
        var s = 63 & t[n++];
        if (192 != (224 & u)) {
          var a = 63 & t[n++];
          if ((u = 224 == (240 & u) ? (15 & u) << 12 | s << 6 | a : (7 & u) << 18 | s << 12 | a << 6 | 63 & t[n++]) < 65536) o += String.fromCharCode(u);else {
            var c = u - 65536;
  ...
  function I(n) {
    v = n, t.HEAP8 = w = new Int8Array(n), t.HEAP16 = new Int16Array(n), t.HEAP32 = A = new Int32Array(n), t.HEAPU8 = b = new Uint8Array(n), t.HEAPU16 = new Uint16Array(n), t.HEAPU32 = R = new Uint32Array(n), t.HEAPF32 = new Float32Array(n), t.HEAPF64 = new Float64Array(n);
  }
  t.INITIAL_MEMORY;
  var T = [],
    H = [],
    D = [];
  function M() {
    if (t.preRun) for ("function" == typeof t.preRun && (t.preRun = [t.preRun]); t.preRun.length;) U(t.preRun.shift());
    V(T);
  }
  function O() {
    V(H);
  ...
  function W() {
    if (t.postRun) for ("function" == typeof t.postRun && (t.postRun = [t.postRun]); t.postRun.length;) C(t.postRun.shift());
    V(D);
  }
  function U(t) {
    T.unshift(t);
  ...
  function L(n) {
    t.onAbort && t.onAbort(n), g(n = "Aborted(" + n + ")"), S = !0, n += ". Build with -sASSERTIONS for more info.";
  ...
  function J(t) {
    try {
      if (t == G && _) return new Uint8Array(_);
      if (u) return u(t);
  ...
  function K() {
    if (!_ && (p || l)) {
      if ("function" == typeof fetch && !Y(G)) return fetch(G, {
        credentials: "same-origin"
      }).then(function (t) {
        if (!t.ok) throw "failed to load wasm binary file at '" + G + "'";
        return t.arrayBuffer();
      }).catch(function () {
        return J(G);
      });
      if (o) return new Promise(function (t, n) {
        o(G, function (n) {
          t(new Uint8Array(n));
        }, n);
      });
  ...
  function Q() {
    ...
    function r(n, e) {
      var r = n.exports;
      t.asm = r, I((y = t.asm.g).buffer), x = t.asm.m, q(t.asm.h), z();
    }
    function i(t) {
      r(t.instance);
    }
    function o(t) {
      return K().then(function (t) {
        ...
        g("failed to asynchronously prepare wasm: " + t), L(t);
      });
    }
    function u() {
      return _ || "function" != typeof WebAssembly.instantiateStreaming || N(G) || Y(G) || h || "function" != typeof fetch ? o(i) : fetch(G, {
        credentials: "same-origin"
      }).then(function (t) {
        return WebAssembly.instantiateStreaming(t, n).then(i, function (t) {
          return g("wasm streaming compile failed: " + t), g("falling back to ArrayBuffer instantiation"), o(i);
        });
      });
    }
    if (k(), t.instantiateWasm) try {
      return t.instantiateWasm(n, r);
    } catch (s) {
      return g("Module.instantiateWasm callback failed with error: " + s), !1;
    }
    return u().catch(e), {};
  }
  function V(n) {
    for (; n.length > 0;) {
      ...
      if ("function" != typeof e) {
        var r = e.func;
        "number" == typeof r ? void 0 === e.arg ? $(r)() : $(r)(e.arg) : r(void 0 === e.arg ? null : e.arg);
      } else e(t);
    }
  }
  ...
  function $(t) {
    var n = Z[t];
    return n || (t >= Z.length && (Z.length = t + 1), Z[t] = n = x.get(t)), n;
  }
  function tt(t, n, e, r) {
    L("Assertion failed: " + E(t) + ", at: " + [n ? E(n) : "unknown filename", e, r ? E(r) : "unknown function"]);
  }
  function nt(t) {
    return ft(t + 24) + 24;
  }
  function et(t) {
    this.excPtr = t, this.ptr = t - 24, this.set_type = function (t) {
      ...
      this.set_adjusted_ptr(0), this.set_type(t), this.set_destructor(n), this.set_refcount(0), this.set_caught(!1), this.set_rethrown(!1);
      ...
      if (lt(this.get_type())) return R[this.excPtr >> 2];
      var t = this.get_adjusted_ptr();
      return 0 !== t ? t : this.excPtr;
    };
  }
  function rt(t, n, e) {
    throw new et(t).init(n, e), t;
  }
  function it() {
    L("");
  }
  ...
  function st(t) {
    try {
      return y.grow(t - v.byteLength + 65535 >>> 16), I(y.buffer), 1;
    } catch (n) {}
  }
  function at(t) {
    var n = b.length;
    ...
    for (var i = 1; i <= 4; i *= 2) {
      var o = n * (1 + .2 / i);
      if (o = Math.min(o, t + 100663296), st(Math.min(e, r(Math.max(t, o), 65536)))) return !0;
    }
    return !1;
  }
  var ct = {
  ...
  var pt,
    lt = t.___cxa_is_pointer_type = function () {
  ...
  function dt(e) {
    function r() {
      pt || (pt = !0, t.calledRun = !0, S || (O(), n(t), t.onRuntimeInitialized && t.onRuntimeInitialized(), W()));
    }
  ...
  if (B = function t() {
    pt || dt(), pt || (B = t);
  }, t.run = dt, t.preInit) for ("function" == typeof t.preInit && (t.preInit = [t.preInit]); t.preInit.length > 0;) t.preInit.pop()();
  return dt(), t.ready;
}, e.exports = i;
var u = o.exports;
const s = n({
...
//# sourceMappingURL=node_modules_arcgis_core_chunks_lerc-wasm_js.js.map