"use strict";
(self["webpackChunkrealgis"] = self["webpackChunkrealgis"] || []).push([["default-node_modules_esri_calcite-components_dist_components_combobox_js"],{
...
/* harmony import */ var _stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @stencil/core/internal/client/index.js */ 40994);
/* harmony import */ var _filter2_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./filter2.js */ 74049);
...
/* harmony import */ var _guid_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./guid.js */ 38722);
/* harmony import */ var _interactive_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./interactive.js */ 59338);
...
/* harmony import */ var _observers_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./observers.js */ 80709);
...
/* harmony import */ var _utils2_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./utils2.js */ 48560);
/* harmony import */ var _component_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./component.js */ 90662);
/* harmony import */ var _calcite_headless_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./calcite-headless.js */ 27937);
/* harmony import */ var _chip_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./chip.js */ 70713);
/* harmony import */ var _icon_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./icon.js */ 2706);
/* harmony import */ var _debounce_js__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./debounce.js */ 27852);
...
function XButton({
  ...
  return (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)("button", {
    "aria-label": label,
    class: CSS.button,
    disabled: disabled,
    key: key,
    ...
    ref: ref
  }, (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)("calcite-icon", {
    icon: "x",
    scale: (0,_component_js__WEBPACK_IMPORTED_MODULE_14__.g)(scale)
  }));
}
...
const isGroup = el => el.tagName === _utils2_js__WEBPACK_IMPORTED_MODULE_13__.f;
const itemUidPrefix = "combobox-item-";
const chipUidPrefix = "combobox-chip-";
const labelUidPrefix = "combobox-label-";
const listboxUidPrefix = "combobox-listbox-";
const inputUidPrefix = "combobox-input-";
const Combobox = /*@__PURE__*/(0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.proxyCustomElement)(class extends _stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.HTMLElement {
  constructor() {
    var _this;
    super();
    _this = this;
    this.__registerHost();
    this.__attachShadow();
    this.calciteComboboxChange = (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.createEvent)(this, "calciteComboboxChange", 6);
    this.calciteComboboxFilterChange = (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.createEvent)(this, "calciteComboboxFilterChange", 6);
    this.calciteComboboxChipClose = (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.createEvent)(this, "calciteComboboxChipClose", 6);
    this.calciteComboboxBeforeClose = (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.createEvent)(this, "calciteComboboxBeforeClose", 6);
    this.calciteComboboxClose = (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.createEvent)(this, "calciteComboboxClose", 6);
    this.calciteComboboxBeforeOpen = (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.createEvent)(this, "calciteComboboxBeforeOpen", 6);
    this.calciteComboboxOpen = (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.createEvent)(this, "calciteComboboxOpen", 6);
    this.placement = _floating_ui_js__WEBPACK_IMPORTED_MODULE_3__.d;
    this.internalValueChangeFlag = false;
    this.textInput = null;
    this.mutationObserver = (0,_observers_js__WEBPACK_IMPORTED_MODULE_10__.c)("mutation", () => this.updateItems());
    this.resizeObserver = (0,_observers_js__WEBPACK_IMPORTED_MODULE_10__.c)("resize", () => {
      this.setMaxScrollerHeight();
      this.refreshSelectionDisplay();
    });
    this.guid = (0,_guid_js__WEBPACK_IMPORTED_MODULE_5__.g)();
    this.inputHeight = 0;
    ...
    this.setMaxScrollerHeight = /*#__PURE__*/(0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        listContainerEl,
        open,
        referenceEl
      ...
      yield _this.reposition(true);
      const maxScrollerHeight = _this.getMaxScrollerHeight();
    ...
    this.refreshSelectionDisplay = /*#__PURE__*/(0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield (0,_loadable_js__WEBPACK_IMPORTED_MODULE_8__.b)(_this);
      if ((0,_utils2_js__WEBPACK_IMPORTED_MODULE_13__.i)(_this.selectionMode)) {
        return;
      }
      if (!_this.textInput) {
        return;
      ...
      const chipContainerElWidth = (0,_dom_js__WEBPACK_IMPORTED_MODULE_2__.u)(chipContainerEl);
      const {
        fontSize,
        fontFamily
      } = getComputedStyle(textInput);
      const inputTextWidth = (0,_dom_js__WEBPACK_IMPORTED_MODULE_2__.v)(placeholder, `${fontSize} ${fontFamily}`);
      const inputWidth = (inputTextWidth || parseInt(_calcite_headless_js__WEBPACK_IMPORTED_MODULE_15__.C)) + chipContainerElGap;
      const allSelectedIndicatorChipElWidth = (0,_dom_js__WEBPACK_IMPORTED_MODULE_2__.u)(allSelectedIndicatorChipEl);
      const selectedIndicatorChipElWidth = (0,_dom_js__WEBPACK_IMPORTED_MODULE_2__.u)(selectedIndicatorChipEl);
      const largestSelectedIndicatorChipWidth = Math.max(allSelectedIndicatorChipElWidth, selectedIndicatorChipElWidth);
      _this.setCompactSelectionDisplay({
        chipContainerElGap,
      ...
      if (selectionDisplay === "fit") {
        const chipEls = Array.from(_this.el.shadowRoot.querySelectorAll("calcite-chip")).filter(chipEl => chipEl.closable);
        const availableHorizontalChipElSpace = Math.round(chipContainerElWidth - ((_this.selectedHiddenChipsCount > 0 ? selectedIndicatorChipElWidth : 0) + chipContainerElGap + inputWidth + chipContainerElGap));
        _this.refreshChipDisplay({
          availableHorizontalChipElSpace,
          chipContainerElGap,
          chipEls
        });
        _this.setVisibleAndHiddenChips(chipEls);
      }
    });
    ...
    this.filterItems = (() => {
      ...
      return (0,_debounce_js__WEBPACK_IMPORTED_MODULE_18__.d)(text => {
        const filteredData = (0,_filter2_js__WEBPACK_IMPORTED_MODULE_1__.f)(this.data, text);
    ...
    this.emitComboboxChange = (0,_debounce_js__WEBPACK_IMPORTED_MODULE_18__.d)(this.internalComboboxChangeEvent, 0);
    this.getSelectedItems = () => {
      ...
      return this.items.filter(item => item.selected && (this.selectionMode !== "ancestors" || !(0,_utils2_js__WEBPACK_IMPORTED_MODULE_13__.h)(item)))
      /** Preserve order of entered tags */.sort((a, b) => {
  ...
  documentClickHandler(event) {
    if (this.disabled || !(0,_dom_js__WEBPACK_IMPORTED_MODULE_2__.j)(event)) {
      return;
    }
    const composedPath = event.composedPath();
  ...
  setFocus() {
    var _this3 = this;
    return (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield (0,_loadable_js__WEBPACK_IMPORTED_MODULE_8__.c)(_this3);
      _this3.textInput?.focus();
      _this3.activeChipIndex = -1;
      _this3.activeItemIndex = -1;
    })();
  }
  // --------------------------------------------------------------------------
  //
  ...
  // --------------------------------------------------------------------------
  connectedCallback() {
    (0,_interactive_js__WEBPACK_IMPORTED_MODULE_6__.c)(this);
  ...
  componentWillLoad() {
    var _this4 = this;
    return (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      (0,_loadable_js__WEBPACK_IMPORTED_MODULE_8__.a)(_this4);
      _this4.updateItems();
      yield (0,_t9n_js__WEBPACK_IMPORTED_MODULE_12__.s)(_this4);
    })();
  }
  componentDidLoad() {
    (0,_form_js__WEBPACK_IMPORTED_MODULE_4__.a)(this, this.getValue());
    this.reposition(true);
  ...
  componentDidRender() {
    ...
    (0,_interactive_js__WEBPACK_IMPORTED_MODULE_6__.u)(this);
  }
  componentDidUpdate() {
    this.refreshSelectionDisplay();
  }
  disconnectedCallback() {
    ...
    (0,_interactive_js__WEBPACK_IMPORTED_MODULE_6__.d)(this);
  ...
  effectiveLocaleChange() {
    (0,_t9n_js__WEBPACK_IMPORTED_MODULE_12__.u)(this, this.effectiveLocale);
  }
  // --------------------------------------------------------------------------
  //
  //  Private Methods
  ...
  hideChip(chipEl) {
    chipEl.classList.add(_utils2_js__WEBPACK_IMPORTED_MODULE_13__.C.chipInvisible);
  }
  showChip(chipEl) {
    chipEl.classList.remove(_utils2_js__WEBPACK_IMPORTED_MODULE_13__.C.chipInvisible);
  }
  refreshChipDisplay({
    chipEls,
    availableHorizontalChipElSpace,
    ...
    chipEls.forEach(chipEl => {
      if (!chipEl.selected) {
        ...
        const chipElWidth = (0,_dom_js__WEBPACK_IMPORTED_MODULE_2__.u)(chipEl);
  ...
  setVisibleAndHiddenChips(chipEls) {
    ...
    chipEls.forEach(chipEl => {
      if (chipEl.selected && !chipEl.classList.contains(_utils2_js__WEBPACK_IMPORTED_MODULE_13__.C.chipInvisible)) {
  ...
  calculateSingleItemHeight(item) {
    ...
    const children = Array.from(item.querySelectorAll(_utils2_js__WEBPACK_IMPORTED_MODULE_13__.b));
    children.map(child => child?.offsetHeight).forEach(offsetHeight => {
      height -= offsetHeight;
    });
    return height;
  }
  ...
  updateAncestors(item) {
    ...
    const ancestors = (0,_utils2_js__WEBPACK_IMPORTED_MODULE_13__.c)(item);
    const children = (0,_utils2_js__WEBPACK_IMPORTED_MODULE_13__.d)(item);
    if (item.selected) {
      ...
      [...ancestors].forEach(el => {
        if (!(0,_utils2_js__WEBPACK_IMPORTED_MODULE_13__.h)(el)) {
          el.selected = false;
        }
      });
    }
  ...
  getNeedsIcon() {
    return (0,_utils2_js__WEBPACK_IMPORTED_MODULE_13__.i)(this.selectionMode) && this.items.some(item => item.icon);
  }
  resetText() {
    if (this.textInput) {
      this.textInput.value = "";
  ...
  getItems() {
    const items = Array.from(this.el.querySelectorAll(_utils2_js__WEBPACK_IMPORTED_MODULE_13__.e));
    return items.filter(item => !item.disabled);
  }
  getGroupItems() {
    return Array.from(this.el.querySelectorAll(_utils2_js__WEBPACK_IMPORTED_MODULE_13__.f));
  }
  addCustomChip(value, focus) {
    ...
    if (existingItem) {
      ...
      const item = document.createElement(_utils2_js__WEBPACK_IMPORTED_MODULE_13__.e);
      item.value = value;
  ...
  isMulti() {
    return !(0,_utils2_js__WEBPACK_IMPORTED_MODULE_13__.i)(this.selectionMode);
  }
  //--------------------------------------------------------------------------
  //
  //  Render Methods
  ...
  renderChips() {
    ...
    return this.selectedItems.map((item, i) => {
      ...
      const ancestors = [...(0,_utils2_js__WEBPACK_IMPORTED_MODULE_13__.c)(item)].reverse();
      const pathLabel = [...ancestors, item].map(el => el.textLabel);
      const label = selectionMode !== "ancestors" ? item.textLabel : pathLabel.join(" / ");
      return (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)("calcite-chip", {
        class: chipClasses,
        closable: true,
        icon: item.icon,
  ...
  renderAllSelectedIndicatorChip() {
    ...
    return (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)("calcite-chip", {
      class: {
        chip: true,
        [_utils2_js__WEBPACK_IMPORTED_MODULE_13__.C.chipInvisible]: !(this.isAllSelected() && !selectedVisibleChipsCount && !compactSelectionDisplay)
      },
      scale: scale,
      title: label,
      value: "",
  ...
  renderSelectedIndicatorChip() {
    ...
    return (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)("calcite-chip", {
      class: {
        chip: true,
        [_utils2_js__WEBPACK_IMPORTED_MODULE_13__.C.chipInvisible]: chipInvisible
      },
      scale: scale,
      title: label,
      value: "",
  ...
  renderInput() {
    ...
    const single = (0,_utils2_js__WEBPACK_IMPORTED_MODULE_13__.i)(selectionMode);
    const selectedItem = selectedItems[0];
    const showLabel = !open && single && !!selectedItem;
    return (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)("span", {
      class: {
        "input-wrap": true,
        "input-wrap--single": single
      }
    }, showLabel && (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)("span", {
      class: {
        label: true,
        "label--icon": !!selectedItem?.icon
      },
      key: "label"
    }, selectedItem.textLabel), (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)("input", {
      "aria-activedescendant": this.activeDescendant,
      "aria-autocomplete": "list",
      "aria-controls": `${listboxUidPrefix}${guid}`,
      "aria-label": (0,_label2_js__WEBPACK_IMPORTED_MODULE_7__.g)(this),
      class: {
        input: true,
        "input--single": true,
  ...
  renderListBoxOptions() {
    return this.filteredItems.map(item => (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)("li", {
      "aria-selected": (0,_dom_js__WEBPACK_IMPORTED_MODULE_2__.t)(item.selected),
  ...
  renderFloatingUIContainer() {
    ...
    const classes = {
      [_utils2_js__WEBPACK_IMPORTED_MODULE_13__.C.listContainer]: true,
      [_floating_ui_js__WEBPACK_IMPORTED_MODULE_3__.F.animation]: true,
      [_floating_ui_js__WEBPACK_IMPORTED_MODULE_3__.F.animationActive]: open
    };
    return (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)("div", {
      "aria-hidden": "true",
      class: {
      ...
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: setFloatingEl
    }, (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)("div", {
      class: classes,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: setContainerEl
    }, (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)("ul", {
      class: {
        list: true,
        "list--hide": !open
      }
    }, (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)("slot", null))));
  }
  renderIconStart() {
    const {
      selectedItems,
    ...
    const singleSelectionMode = (0,_utils2_js__WEBPACK_IMPORTED_MODULE_13__.i)(selectionMode);
    const iconAtStart = !this.open && selectedItem ? !!selectedIcon && singleSelectionMode : !!this.placeholderIcon && (!selectedItem || singleSelectionMode);
    return iconAtStart && (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)("span", {
      class: "icon-start"
    }, (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)("calcite-icon", {
      class: "selected-icon",
      ...
      scale: (0,_component_js__WEBPACK_IMPORTED_MODULE_14__.g)(this.scale)
    }));
  }
  renderIconEnd() {
    const {
  ...
  render() {
    ...
    const singleSelectionMode = (0,_utils2_js__WEBPACK_IMPORTED_MODULE_13__.i)(this.selectionMode);
    ...
    return (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)(_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.Host, {
      onClick: this.comboboxFocusHandler
    }, (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)("div", {
      "aria-autocomplete": "list",
      "aria-controls": `${listboxUidPrefix}${guid}`,
      "aria-expanded": (0,_dom_js__WEBPACK_IMPORTED_MODULE_2__.t)(open),
      ...
      class: {
        "grid-input": true,
        [_utils2_js__WEBPACK_IMPORTED_MODULE_13__.C.selectionDisplayFit]: fitSelectionDisplay,
        [_utils2_js__WEBPACK_IMPORTED_MODULE_13__.C.selectionDisplaySingle]: singleSelectionDisplay
      },
      ref: this.setChipContainerEl
    }, this.renderIconStart(), !singleSelectionMode && !singleSelectionDisplay && this.renderChips(), !singleSelectionMode && !allSelectionDisplay && [this.renderSelectedIndicatorChip(), this.renderSelectedIndicatorChipCompact(), this.renderAllSelectedIndicatorChip(), this.renderAllSelectedIndicatorChipCompact()], (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)("label", {
      class: "screen-readers-only",
      htmlFor: `${inputUidPrefix}${guid}`,
      id: `${labelUidPrefix}${guid}`
    }, label), this.renderInput()), isClearable ? (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)(XButton, {
      disabled: this.disabled,
      key: "close-button",
      label: this.messages.clear,
      scale: this.scale
    }) : null, this.renderIconEnd()), (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)("ul", {
      ...
      role: "listbox",
      tabIndex: -1
    }, this.renderListBoxOptions()), this.renderFloatingUIContainer(), (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_19__.h)(_form_js__WEBPACK_IMPORTED_MODULE_4__.H, {
      component: this
    }));
  }
...
function defineCustomElement() {
  ...
  components.forEach(tagName => {
    switch (tagName) {
      ...
      case "calcite-chip":
        if (!customElements.get(tagName)) {
          (0,_chip_js__WEBPACK_IMPORTED_MODULE_16__.d)();
        }
        break;
      case "calcite-icon":
        if (!customElements.get(tagName)) {
...
//# sourceMappingURL=default-node_modules_esri_calcite-components_dist_components_combobox_js.js.map