"use strict";
(self["webpackChunkrealgis"] = self["webpackChunkrealgis"] || []).push([["default-node_modules_esri_calcite-components_dist_components_floating-ui_js-node_modules_esri-644dca"],{
...
/* harmony import */ var _debounce_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./debounce.js */ 27852);
...
const computePosition$1 = /*#__PURE__*/function () {
  var _ref2 = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (reference, floating, config) {
    const {
      placement = 'bottom',
      strategy = 'absolute',
      middleware = [],
...
function _detectOverflow() {
  _detectOverflow = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (state, options) {
...
function _convertValueToCoords() {
  _convertValueToCoords = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (state, options) {
    const {
      placement,
      platform,
      elements
...
const getElementRects = /*#__PURE__*/function () {
  var _ref3 = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (_ref) {
    let {
      reference,
      floating,
      strategy
...
(function setUpFloatingUiForShadowDomPositioning() {
  if (_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_3__.Build.isBrowser) {
...
function () {
  var _ref4 = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (component, {
    referenceEl,
    floatingEl,
  ...
  return function positionFloatingUI(_x9, _x10) {
...
function getEffectivePlacement(floatingEl, placement) {
  ...
  if ((0,_dom_js__WEBPACK_IMPORTED_MODULE_1__.b)(floatingEl) === "rtl") {
    placements.reverse();
  }
 ...
 */
function reposition(_x11, _x12) {
  return _reposition.apply(this, arguments);
}
function _reposition() {
  _reposition = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (component, options, delayed = false) {
...
function getDebouncedReposition(component) {
  ...
  debounced = (0,_debounce_js__WEBPACK_IMPORTED_MODULE_2__.d)(positionFloatingUI, repositionDebounceTimeout, {
    leading: true,
...
function connectFloatingUI(component, referenceEl, floatingEl) {
  ...
  const runAutoUpdate = _stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_3__.Build.isBrowser ? autoUpdate : (_refEl, _floatingEl, updateCallback) => {
    updateCallback();
    return () => {
      /* noop */
    };
...
function onToggleOpenCloseComponent(component, nonOpenCloseComponent = false) {
  (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_0__.readTask)(() => {
    if (component.transitionEl) {
      const {
        transitionDuration: allDurations,
        transitionProperty: allProps
      } = getComputedStyle(component.transitionEl);
...
//# sourceMappingURL=default-node_modules_esri_calcite-components_dist_components_floating-ui_js-node_modules_esri-644dca.js.map