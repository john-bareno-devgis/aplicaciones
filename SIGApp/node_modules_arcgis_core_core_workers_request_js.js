"use strict";
(self["webpackChunkrealgis"] = self["webpackChunkrealgis"] || []).push([["node_modules_arcgis_core_core_workers_request_js"],{
...
/* harmony import */ var _Error_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Error.js */ 32995);
...
function e(e, s) {
  ...
  return delete s.signal, globalThis.invokeStaticMessage("request", {
    ...
    var _ref = (0,_home_ohnj_Documentos_realG4Life_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (n) {
      let o, i, l, u, c;
      if (n.data) if (n.data instanceof ArrayBuffer) {
        if (!("json" !== a && "text" !== a && "blob" !== a || (o = new Blob([n.data]), "json" !== a && "text" !== a || (u = yield o.text(), "json" !== a)))) {
          try {
            ...
            throw new _Error_js__WEBPACK_IMPORTED_MODULE_1__["default"]("request:server", p.message, a);
          }
          if (i.error) {
            const a = {
              ...i.error,
            ...
            throw new _Error_js__WEBPACK_IMPORTED_MODULE_1__["default"]("request:server", i.error.message, a);
          }
        }
